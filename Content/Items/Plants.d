...
INSTANCE ItFo_Plants_Herb_04(C_Item)
{	
	...
	visual 				=	"ItFo_Plants_Herb_04.3ds";
	material 			=	MAT_WOOD;
	on_state[0]			=	UsePlants4;
	scemeName			=	"FOOD";

	description			= name;
	TEXT[1]				= NAME_Bonus_HP;				COUNT[1]	= 80;
	//TEXT[2]				= 	"Bardzo rzadki sk³adnik alchemiczny.";
	TEXT[5]				= NAME_Value;					COUNT[5]	= Value_Heilkräuter3;
};
...
/******************************************************************************************/
INSTANCE ItFo_SnakeHerb(C_Item)
{	
	name 				=	"Wê¿owiec";
...
func void UseSnakeHerb ()
{
  Npc_ChangeAttribute	(self,	ATR_HITPOINTS,	5);
}; 		
/******************************************************************************************/
INSTANCE ItFo_MudHerb(C_Item)
{	
	name 				=	"B³otnik";
	...
	visual 				=	"ER_PLANTS_HERB_01.3DS";
	material 			=	MAT_WOOD;
	on_state[0]			= 	UseMudHerb;
	scemeName			=	"FOOD";
...
func void UseMudHerb ()
{
  B_RaiseAttribute	(ATR_HITPOINTS_MAX,	HPMax_Extrakt);
}; 		
/******************************************************************************************/
INSTANCE ItFo_MgiHerb(C_Item)
{	
	name 				=	"Mgie³ka";
	...
	visual 				=	"ITFO_PLANTS_HERB_06.3ds";
	material 			=	MAT_WOOD;
	on_state[0]			= 	UseMgiHerb;
	scemeName			=	"FOOD";
...
func void UseMgiHerb ()
{
  Npc_ChangeAttribute	(self,	ATR_HITPOINTS,	5);
}; 		
/******************************************************************************************/
INSTANCE ItFo_MudSeed(C_Item)
{	
	name 				=	"Nasiona b³otnika";
