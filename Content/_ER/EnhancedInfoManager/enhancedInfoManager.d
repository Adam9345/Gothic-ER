			...
			|| (refreshOverlays)
			{
				...
				*/
				...
				if (descriptionAvailable)
				{
					...
					//o@ h@FF8000 :(1) ~Dobrá, co bych mìl vìdìt o o@hs@FF8000:tomhle~ místì?
					//o@:Dobrá, co bych mìl vìdìt o ~o@hs@FF8000:tomhle~ místì?
					...
					if ((index > -1) && (index2 > index) && (index3 > index2))
					{
						...
						if (index > -1) {
							...
							// h@FF8000 :(1) ~Dobrá, co bych mìl vìdìt o o@hs@FF8000:tomhle~ místì?
							//:Dobrá, co bych mìl vìdìt o ~o@hs@FF8000:tomhle~ místì?
						...
						if (index > -1) {
							// h@FF8000 :(1)
							//:Dobrá, co bych mìl vìdìt o
							s3 = mySTR_Prefix (s2, index);

							//Dobrá, co bych mìl vìdìt o o@hs@FF8000:tomhle~ místì?
							//o@hs@FF8000:tomhle~ místì?
