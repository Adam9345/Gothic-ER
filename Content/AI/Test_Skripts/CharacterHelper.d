...
func VOID CH_Level_Info()
{
	...
	Info_AddChoice		(CH_Level, "Wstecz"			 , CH_Level_BACK);
	Info_AddChoice		(CH_Level, "Poziom  1 -  5" , CH_Level1);
	Info_AddChoice		(CH_Level, "Poziom  6 - 10" , CH_Level6);
	Info_AddChoice		(CH_Level, "Poziom 11 - 15" , CH_Level11);
	Info_AddChoice		(CH_Level, "Poziom 16 - 20" , CH_Level16);
	Info_AddChoice		(CH_Level, "Poziom 21 - 25" , CH_Level21);
	Info_AddChoice		(CH_Level, "Poziom 26 - 30" , CH_Level26);
};
...
func void CH_Level26()
{
	...
	Info_AddChoice		(CH_Level, "Wstecz"		, CH_Level_BACK);
	Info_AddChoice		(CH_Level, "Poziom 26" , CH_Level_26);
	Info_AddChoice		(CH_Level, "Poziom 27" , CH_Level_27);
	Info_AddChoice		(CH_Level, "Poziom 28" , CH_Level_28);
	Info_AddChoice		(CH_Level, "Poziom 29" , CH_Level_29);
	Info_AddChoice		(CH_Level, "Poziom 30" , CH_Level_30);
};  
...
func void CH_Level21()
{
	...
	Info_AddChoice		(CH_Level, "Wstecz"		, CH_Level_BACK);
	Info_AddChoice		(CH_Level, "Poziom 21" , CH_Level_21);
	Info_AddChoice		(CH_Level, "Poziom 22" , CH_Level_22);
	Info_AddChoice		(CH_Level, "Poziom 23" , CH_Level_23);
	Info_AddChoice		(CH_Level, "Poziom 24" , CH_Level_24);
	Info_AddChoice		(CH_Level, "Poziom 25" , CH_Level_25);
};  
...
func void CH_Level16()
{
	...
	Info_AddChoice		(CH_Level, "Wstecz"		, CH_Level_BACK);
	Info_AddChoice		(CH_Level, "Poziom 16" , CH_Level_16);
	Info_AddChoice		(CH_Level, "Poziom 17" , CH_Level_17);
	Info_AddChoice		(CH_Level, "Poziom 18" , CH_Level_18);
	Info_AddChoice		(CH_Level, "Poziom 19" , CH_Level_19);
	Info_AddChoice		(CH_Level, "Poziom 20" , CH_Level_20);
};
...
func void CH_Level11()
{
	...
	Info_AddChoice		(CH_Level, "Wstecz"		, CH_Level_BACK);
	Info_AddChoice		(CH_Level, "Poziom 11" , CH_Level_11);
	Info_AddChoice		(CH_Level, "Poziom 12" , CH_Level_12);
	Info_AddChoice		(CH_Level, "Poziom 13" , CH_Level_13);
	Info_AddChoice		(CH_Level, "Poziom 14" , CH_Level_14);
	Info_AddChoice		(CH_Level, "Poziom 15" , CH_Level_15);	
};
...
func void CH_Level6()
{
	...
	Info_AddChoice		(CH_Level, "Wstecz"	    , CH_Level_BACK);
	Info_AddChoice		(CH_Level, "Poziom  6" , CH_Level_6);
	Info_AddChoice		(CH_Level, "Poziom  7" , CH_Level_7);
	Info_AddChoice		(CH_Level, "Poziom  8" , CH_Level_8);
	Info_AddChoice		(CH_Level, "Poziom  9" , CH_Level_9);
	Info_AddChoice		(CH_Level, "Poziom 10" , CH_Level_10);	
};
...
func void CH_Level1()
{
	...
	Info_AddChoice		(CH_Level, "Wstecz"		, CH_Level_BACK);
	Info_AddChoice		(CH_Level, "Poziom 1" 	, CH_Level_1);
	Info_AddChoice		(CH_Level, "Poziom 2" 	, CH_Level_2);
	Info_AddChoice		(CH_Level, "Poziom 3" 	, CH_Level_3);
	Info_AddChoice		(CH_Level, "Poziom 4" 	, CH_Level_4);
	Info_AddChoice		(CH_Level, "Poziom 5" 	, CH_Level_5);	
};
...
func VOID CH_Guild_Info()
{
	...
	Info_AddChoice		(CH_Guild, "Wstecz"			 , CH_Guild_BACK);
	if ((hero.level >= 6) && (hero.level <= 10))
	{
	    Info_AddChoice		(CH_Guild, "Cieñ"      , CH_Shadow);
    };
    if ((hero.level >= 10) && (hero.level <= 15))
	{	    
	    Info_AddChoice		(CH_Guild, "Stra¿nik"       , CH_Guard);
	};
	
	if ((hero.level >= 10) && (hero.level <= 15))
	{    
	    Info_AddChoice		(CH_Guild, "Mag Ognia"   , CH_Firemage);
	};
	if ((hero.level >= 6) && (hero.level <= 10))
	{
	    Info_AddChoice		(CH_Guild, "Szkodnik"        , CH_Bandit);
	};
	if ((hero.level >= 10))
	{    
	    Info_AddChoice		(CH_Guild, "Najemnik"       , CH_Mercenary);
	};
	if ((hero.level >= 16))
	{    
	    Info_AddChoice		(CH_Guild, "Mag Wody"  , CH_Watermage);
	};
	if ((hero.level >= 6) && (hero.level <= 10))
	{    
	    Info_AddChoice		(CH_Guild, "Nowicjusz"        , CH_Novice);
	};
	if ((hero.level >= 10))
	{    
	    Info_AddChoice		(CH_Guild, "Stra¿nik Œwi¹tynny"       , CH_Templar);
	};    
	if ((hero.level >= 15))
	{    
	 ...
	 if ((hero.level >= 10) && (hero.level <= 15)) /////////////-----------------------------
	{	    
	    Info_AddChoice		(CH_Guild, "Bandyta"       , CH_Bandit2);
	};
	
};
func void CH_Bandit2()
{
	Info_ClearChoices	(CH_Guild);
	...
	if hero.level <= 16
	{
	    CreateInvItem(hero,BAU_ARMOR_M);
	    AI_EquipArmor(hero,BAU_ARMOR_M);
	}
	else
	{
	    CreateInvItem(hero,BAU_ARMOR_H);
	    AI_EquipArmor(hero,BAU_ARMOR_H);
	};        
};  
...
func void CH_Training_Mana_Info()
{
	...
	Info_AddChoice		(CH_Training_Mana, "Wstecz"	     					, CH_Training_Mana_BACK);
...
func void CH_Training_Combat_Info()
{
	...
	Info_AddChoice		(CH_Training_Combat, "Wstecz"	     				, CH_Training_Combat_BACK);
...
func void CH_Training_Magic_Info()
{
	...
	Info_AddChoice		(CH_Training_Magic, "Wstecz"	     					, CH_Training_Magic_BACK);
...
INSTANCE CH_Training_Thievery (C_INFO)
{
	...
	important		= 0;
	permanent		= 1;
	description		= "Zdolnoœci z³odziejskie"; 
};
