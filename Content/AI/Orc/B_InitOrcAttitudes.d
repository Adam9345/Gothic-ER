...
/*
	...
	*/
	...
	/*
		if (Npc_HasItems (pc_hero, ulumulu) >=1)
	{
		B_SetGuildAttitude	(GIL_ORCSLAVE	,	ATT_FRIENDLY,	GIL_GRD		);
		B_SetGuildAttitude	(GIL_ORCSLAVE	,	ATT_FRIENDLY,	GIL_SLD	);
		B_SetGuildAttitude	(GIL_ORCSLAVE	,	ATT_FRIENDLY,	GIL_TPL		);
		B_SetGuildAttitude	(GIL_ORCSLAVE	,	ATT_FRIENDLY,	GIL_BAU		);
		B_SetGuildAttitude	(GIL_ORCSLAVE	,	ATT_FRIENDLY,	GIL_KDF		);
		B_SetGuildAttitude	(GIL_ORCSLAVE	,	ATT_FRIENDLY,	GIL_KDW		);
