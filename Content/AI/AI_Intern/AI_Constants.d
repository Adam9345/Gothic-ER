...
const int 	AIV_POISON						= 43;   //sprawdŸ czy ten aivar nie jest ju¿ u¿ywany
const int 	AIV_NPCISTRADER					= 44;
const int   AIV_Gender                      = 45;
const int   AIV_LOADGAME                    = 46;
const int   AIV_TradesmanData               = 48;
const int   AIV_MM_Packhunter                  = 49;  
//const int   				= 50;  
	// Enthält den Status einer Durchgangswache
...
const int	HAI_DIST_FOLLOWPC				= 300;							// NSC im TA-Zustand ZS_FollowPC entfernt sich höchstens bis zu dieser Distanz. Bei Überschreiten schließt er wieder auf
...
const int MOBSI_IRONHACKEN    = 8;
const int MOBSI_COOKING       = 9;
const int MOBSI_POUND         = 10;
const int MOBSI_REST          = 11;
const int MOBSI_SMELTINGOT    = 12;
const int MOBSI_PRAYJO        = 13;
const int MOBSI_OreHACKEN     = 14;
const int MOBSI_FastTravel    = 15;
const int MOBSI_WOODWORK      = 16;
const int MOBSI_GHOSTALTAR    = 17;
const int MOBSI_DEFENDWALL    = 18;
const int MOBSI_DEFENDWALLBDT = 19;
const int MOBSI_KAPLICA       = 20;
const int MOBSI_COOKPAN       = 21;
const int MOBSI_SMOKE         = 22;
