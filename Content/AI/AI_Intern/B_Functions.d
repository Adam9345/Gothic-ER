...
func void B_ClearRuneInv (var C_NPC self) 
{
    var C_NPC her;     her = Hlp_GetNpc(PC_Hero);   // mo¿na zrobiæ tak samo dla prêtów czy ostrza aby gracz nie móg³ mno¿yæ tego w nieskoñczonoœæ !! albo aby usuwaæ miêso z postaci etc 
    
    if  (Hlp_GetInstanceID(self) != Hlp_GetInstanceID(her))
    {    
    Npc_RemoveInvItems    (self ,ItArRuneFirebolt         , Npc_HasItems (self, ItArRuneFirebolt         ));
    Npc_RemoveInvItems    (self ,ItArRuneFireball         , Npc_HasItems (self, ItArRuneFireball         ));
    Npc_RemoveInvItems    (self ,ItArRuneFirestorm        , Npc_HasItems (self, ItArRuneFirestorm        ));
    Npc_RemoveInvItems    (self ,ItArRuneFireRain         , Npc_HasItems (self, ItArRuneFireRain         ));
    Npc_RemoveInvItems    (self ,ItArRuneLight            , Npc_HasItems (self, ItArRuneLight            ));
    Npc_RemoveInvItems    (self ,ItArRuneHeal             , Npc_HasItems (self, ItArRuneHeal             ));
    Npc_RemoveInvItems    (self ,ItArRuneChainLightning   , Npc_HasItems (self, ItArRuneChainLightning   ));
    Npc_RemoveInvItems    (self ,ItArRuneThunderbolt      , Npc_HasItems (self, ItArRuneThunderbolt      ));
    Npc_RemoveInvItems    (self ,ItArRuneThunderball      , Npc_HasItems (self, ItArRuneThunderball      ));
    Npc_RemoveInvItems    (self ,ItArRuneIceCube          , Npc_HasItems (self, ItArRuneIceCube          ));
    Npc_RemoveInvItems    (self ,ItArRuneIceWave          , Npc_HasItems (self, ItArRuneIceWave          ));
    Npc_RemoveInvItems    (self ,ItArRuneDestroyUndead    , Npc_HasItems (self, ItArRuneDestroyUndead    ));
    Npc_RemoveInvItems    (self ,ItArRuneWindfist         , Npc_HasItems (self, ItArRuneWindfist         ));
    };
};