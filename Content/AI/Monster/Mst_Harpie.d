...
INSTANCE HarpieSak1	(Mst_Default_Harpie)
{
	name							=	"Harpia";
	guild							=	GIL_DEMON;
	aivar[AIV_MM_REAL_ID]			= 	ID_HARPIE;
...
INSTANCE HarpieSak2	(Mst_Default_Harpie)
{
name							=	"Harpia";
	guild							=	GIL_DEMON;
	aivar[AIV_MM_REAL_ID]			= 	ID_HARPIE;
...
INSTANCE HarpieSak3	(Mst_Default_Harpie)
{
	name							=	"Harpia";
	guild							=	GIL_DEMON;
	aivar[AIV_MM_REAL_ID]			= 	ID_HARPIE;
...
INSTANCE HarpieSak4	(Mst_Default_Harpie)
{
	name							=	"Harpia";
	guild							=	GIL_DEMON;
	aivar[AIV_MM_REAL_ID]			= 	ID_HARPIE;
...
INSTANCE HarpieSak5	(Mst_Default_Harpie)
{
	name							=	"Harpia";
	guild							=	GIL_DEMON;
	aivar[AIV_MM_REAL_ID]			= 	ID_HARPIE;
