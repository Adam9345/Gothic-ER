...
func void Set_NCFireWaran1_Visuals()
{
	Mdl_SetVisual			(self,	"Waran.mds");
	Mdl_ApplyOverlayMds 	(self,	"Firewaran.mds");
    Mdl_SetModelScale(self, 1.2, 1.2, 1.2);
	//								Body-Mesh		Body-Tex	Skin-Color	Head-MMS	Head-Tex	Teeth-Tex	ARMOR
	Mdl_SetVisualBody		(self,	"WAR_FIRE_BODYNC",DEFAULT,	DEFAULT,	"",			DEFAULT,  	DEFAULT,	-1);
};
...
INSTANCE NCFireWaran1	(Mst_Default_FireWaran)
{
	Set_NCFireWaran1_Visuals();
	Npc_SetToFistMode(self);
};

INSTANCE NCFireWaran2	(Mst_Default_FireWaran)
{
	Set_NCFireWaran1_Visuals();
	Npc_SetToFistMode(self);
};

INSTANCE NCFireWaran3	(Mst_Default_FireWaran)
{
	Set_NCFireWaran1_Visuals();
	Npc_SetToFistMode(self);
};

INSTANCE NCFireWaran4	(Mst_Default_FireWaran)
{
	Set_NCFireWaran1_Visuals();
	Npc_SetToFistMode(self);
};
