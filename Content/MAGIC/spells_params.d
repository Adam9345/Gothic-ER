...
const int	SPL_SENDCAST_TELEPORT		=	10;
...
const int	SPL_SENDCAST_TRF_CRAWLER	=	15;
const int	SPL_SENDCAST_TRF_SNAPPER	=	15;
...
const int	SPL_SENDCAST_WINDWAVE		=	8;

const int	SPL_SENDCAST_SUMMONDEMON	=	15;
const int	SPL_SENDCAST_SUMMONSKELETON	=	10;
const int	SPL_SENDCAST_SUMMONGOLEM	=	15;
const int	SPL_SENDCAST_ARMYOFDARKNESS	=	15;

const int	SPL_SENDCAST_MASSDEATH		=	40;
...
INSTANCE Spell_WindWave (C_Spell_Proto)
{
	time_per_mana			= 0;
	spelltype 				= SPELL_BAD;
	damage_per_level 		= SPL_DAMAGE_STORMFIST;					// Relativer Schaden je nach Opfer wird im zs_MagicFreeze angegeben!
	damageType				= DAM_FLY;
	targetCollectAlgo		= TARGET_COLLECT_FOCUS_FALLBACK_NONE;	// Opfer werden aber erst durch Kollision mit dem Effekt "eingefroren"
	targetCollectRange		= 1500;					// 15m
	targetCollectAzi		= 360;
	targetCollectElev		= 60;
	targetCollectType		= TARGET_TYPE_NPCS;
