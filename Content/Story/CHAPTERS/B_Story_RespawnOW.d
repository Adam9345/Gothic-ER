...
func void B_Story_RespawnOW_Ch3()
{
	...
	Wld_InsertNpc	    (OrcBiter,"OW_PATH_3_07");
	//-----------------------------------------------------------1.6.1----------------------------------
	Wld_InsertNpc		(Snapper,"WP_ADD_SNA_01");
	Wld_InsertNpc		(Snapper,"WP_ADD_SNA_02");
//	Wld_InsertNpc		(Snapper,"WP_ADD_SNA_03");
	
	Wld_InsertNpc		(Snapper,"OW_PATH_SCAVENGER13_SPAWN01");
	Wld_InsertNpc		(Snapper,"MOVEMENT_OW_PATH_SCAVENGER13_SPAWN01");
	Wld_InsertNpc		(Snapper,"OW_PATH_SCAVENGER13_SPAWN01");
	
	
	
	Wld_InsertNpc		(Warg,"WP_ADD_WARG_05");
	Wld_InsertNpc		(Warg,"WP_ADD_WARG_06");
	Wld_InsertNpc		(Warg,"WP_ADD_WARG_07");
	Wld_InsertNpc		(Warg,"WP_ADD_WARG_08");
	Wld_InsertNpc		(Warg,"WP_ADD_WARG_09");
	Wld_InsertNpc		(Warg,"WP_ADD_WARG_10");
	Wld_InsertNpc		(Warg,"WP_ADD_WARG_11");
	Wld_InsertNpc		(Warg,"WP_ADD_WARG_12");
	...
	Wld_InsertItem			(ItFo_Plants_Herb_03,"FP_ITEM_ADD_01");
	Wld_InsertItem			(ItFo_GreenMushroom,"FP_ITEM_ADD_02");
	Wld_InsertItem			(ItFo_GreenMushroom,"FP_ITEM_ADD_03");
	Wld_InsertItem			(ItMi_GoldCandleHolder,"FP_ITEM_ADD_04");
...
func void B_Story_RespawnOW_Ch4 ()
{
	...
	Wld_InsertNpc	    (Razor,"FP_ROAM_ADD_RAZOR_01");
	Wld_InsertNpc	    (Razor,"FP_ROAM_ADD_RAZOR_02");
	Wld_InsertNpc	    (Razor,"FP_ROAM_ADD_RAZOR_03");
	Wld_InsertNpc	    (Razor,"FP_ROAM_ADD_RAZOR_04");
	Wld_InsertNpc	    (Razor,"FP_ROAM_ADD_RAZOR_05");
	//Wld_InsertNpc	    (Snapper,"WP_ADD_SNA_03");
	
	Wld_InsertNpc	    (OrcWarrior2,"OW_PATH_3_03");
	Wld_InsertNpc		(Warg,"FP_ROAM_OW_WOLF_08_08");
	Wld_InsertNpc		(Warg,"FP_ROAM_OW_WOLF_08_08");
	Wld_InsertNpc		(Warg,"FP_ROAM_OW_WOLF_08_01");
	Wld_InsertNpc		(Warg,"FP_ROAM_OW_WOLF_08_06");
	Wld_InsertNpc		(Warg,"FP_ROAM_DEADWOOD_WOLF_04");
	Wld_InsertNpc		(Warg,"FP_ROAM_DEADWOOD_WOLF_02");
	Wld_InsertNpc		(Warg,"FP_ROAM_OW_BLOODFLY_05_06");
	Wld_InsertNpc		(Warg,"FP_ROAM_OW_WOLF_GRU3");
	Wld_InsertNpc		(Warg,"FP_ROAM_OW_WOLF_GRU1");
	
	
	Wld_InsertNpc		(YoungTroll,"FP_ROAM_ADD_TROLL_01");
...
func void B_Story_RespawnOW_Ch5 ()
{
	...
	Wld_InsertNpc		(Waran,"OW_PATH_OW_PATH_WARAN05_SPAWN01");
	Wld_InsertNpc		(BlackGobboWarrior,"SPAWN_OW_BLACKGOBBO_A1");
	Wld_InsertNpc		(Warg,"SPAWN_SCAVENGER_PATH_OC_PSI_03");
	...
	Wld_InsertNpc		(Warg,"SPAWN_OW_SCAVENGER_OCWOOD1");
	Wld_InsertNpc		(Warg,"SPAWN_O_SCAVENGER_05_02");
	Wld_InsertNpc		(Warg,"SPAWN_O_SCAVENGER_OCWOODL2");
	Wld_InsertNpc		(Warg,"SPAWN_SCAVENGERPATH_OC_PSI_14");
	Wld_InsertNpc		(OrcDog,"OW_PATH_WOLF04_SPAWN01");
	Wld_InsertNpc		(AngryBloodfly,"PATH_TAKE_HERB_MOVEMENT2");
	Wld_InsertNpc		(Firewaran,"OW_COAST_SHIPWRECK_WARAN_2");
	Wld_InsertNpc		(AngryBloodfly,"SPAWN_OW_BLOODFLYS_152");
	...
	Wld_InsertNpc		(OrcWarrior2,		"OW_DEADWOOD_WOLF_SPAWN01");
	Wld_InsertNpc		(OrcWarrior2,		"OW_DEADWOOD_WOLF_SPAWN01");
	Wld_InsertNpc		(OrcWarrior2,		"OW_DEADWOOD_WOLF_SPAWN01");
	
	Wld_InsertNpc		(OrcWarrior2,		"WP_ORC_ADD_01");
	Wld_InsertNpc		(OrcWarrior2,		"WP_ORC_ADD_02");
	Wld_InsertNpc		(OrcWarrior2,		"OW_PATH_272");
