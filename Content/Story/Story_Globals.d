...
const int T_MEGA  = 120;
const int T_VHIG  = 100;
const int T_HIGH  = 80;
const int T_MED   = 60;
const int T_LOW   = 40;
var int	FM_GateOpen;//oryginalna gry
 ...
 var int loc_OC;
 var int loc_ricefields;
 var int loc_NC_cave;
 var int loc_FMC;
 var int loc_OMC;
 var int loc_QC;
 var int loc_hunters;
 var int loc_orchunters;
 var int loc_abmine;
 var int loc_citadel;
 var int loc_cavalorn;
 var int loc_aidan;
 var int loc_klasztor;
 var int loc_fogtower;
 var int loc_klify;
 var int loc_psicamp;
 var int loc_swamp;
 var int loc_forest;
 var int loc_orcdesert;
 
 var int FastTravel_Locked;
//**************************
...
var int HeroANPWDoyle; 			//perm dia DIA_Raeuber_NAPASC, tru na DIA_Quentin_QUEST4
...
const int FastTravelDIA = 44; 
 const int OdpoczynekABIT = 45;
...
//------------------------------------SUB
var int MIS_dlugfletchera;

var int Hanis_Charged;
var int MIS_DLUGHAN;
var int GrabarzIsDead;
var int GrabarzIsDead1;
