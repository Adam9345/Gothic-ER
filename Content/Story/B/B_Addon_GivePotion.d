...
func void B_UseItem (var C_NPC slf, var int itmInstance)
{
	...
	if (Hlp_IsValidNpc(other)) //wenn ich irgendein lookAt-Target habe
	{
		AI_StopLookAt (slf);
...
FUNC INT DIA_Addon_GivePotion_Condition()
{
	...
	&& (self.flags	!= NPC_FLAG_IMMORTAL)	
	{
		...
		|| (Npc_HasItems (other,ItFo_Potion_Health_02) >= 1)
		|| (Npc_HasItems (other,ItFo_Potion_Health_03) >= 1)
		{
			return TRUE;
		};
	};
...
{	
	...
	{
		Info_AddChoice (DIA_Addon_GivePotion,"(Eliksir uzdrawiaj¹cy)",DIA_Addon_GivePotion_ItPo_Health_03);
	};
	if (Npc_HasItems (other,ItFo_Potion_Health_02) >= 1)
	{
		Info_AddChoice (DIA_Addon_GivePotion,"(Wyci¹g uzdrawiaj¹cy )",DIA_Addon_GivePotion_ItPo_Health_02);
	};
	if (Npc_HasItems (other,ItFo_Potion_Health_01) >= 1)
	{
		Info_AddChoice (DIA_Addon_GivePotion,"(Esencja uzdrawiaj¹ca)",DIA_Addon_GivePotion_ItPo_Health_01);
	};
};
// ------------------------------------------------------------
func void B_Addon_DrinkPotion ()
{
	...
	{
		if (Npc_HasItems(self,ItFo_Potion_Health_03) > 0)			
		{
			B_UseItem (self, ItFo_Potion_Health_03);
		}
		else if (Npc_HasItems(self,ItFo_Potion_Health_02) > 0)
		{
			B_UseItem (self, ItFo_Potion_Health_02);
		}
		else if (Npc_HasItems (self,ItFo_Potion_Health_01) > 0)
		{
			B_UseItem (self, ItFo_Potion_Health_01);
		};
	};
