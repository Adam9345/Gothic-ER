...
func void DIA_Ralph_Camp_Whistler ()
{
	...
	AI_Output (other, self,"DIA_Ralph_Camp_Whistler_15_04"); //Nie przepadaj¹ za sob¹ ze wzglêdu na konkurencjê? Czy konflikt podszyty jest czymœ wiêcej?
	...
	AI_Output (self, other,"DIA_Ralph_Camp_Whistler_04_08"); //Ca³a ta jego szwalnia to jeden wielki przekrêt. Dlaczego? Bo wykorzystuje do pracy ludzi Iana, którzy tu przyszli z kopalni.
	AI_Output (self, other,"DIA_Ralph_Camp_Whistler_04_09"); //Jak tylko naczelnik kopalni siê o tym dowie, to Œwistak bêdzie mia³ k³opoty w ca³ym Obozie. Ostatecznie Ian i Thorus to kumple. 
};
...
func VOID DIA_Ralph_Past_Info()
{
	...
	AI_Output (self, other,"DIA_Ralph_Past_04_03"); //Malwersacje finansowe. Kilkanaœcie lat temu kilku potê¿nych arystokratów z Vengardu razem z królem za³o¿y³o spó³kê handlow¹.
	...
	AI_Output (self, other,"DIA_Ralph_Past_04_06"); //Podoba³a mi siê w tamtym czasie pewna panna. Jej ojciec równie¿ by³ kupcem, jednak popada³ w ruinê.
	...
	AI_Output (self, other,"DIA_Ralph_Past_04_08"); //Jednak, aby w ksiêgach siê wszystko zgadza³o podpisywa³e ró¿ne ma³o dochodowe kontrakty. Gdy królewska spó³ka zaczê³a odnotowa³a pow¹zne straty finansowe, zaostrzono kontrolê.
	...
	AI_Output (self, other,"DIA_Ralph_Past_04_10"); //Piêkna Izabela w której siê kocha³em wysz³a za bogatego arystokratê. Jej ojciec dziêki moim przekrêtom wyszed³ na prost¹.
	AI_Output (self, other,"DIA_Ralph_Past_04_11"); //Okaza³o siê, ¿e ona przez ca³y czas mnie oszukiwa³a. Nigdy mnie nie kocha³a. Uwa¿a³a bowiem, ¿e to mezalians dla damy jej pokroju poœlubiæ syna kupca, takiego jak ja. 
	...
	AI_Output (self, other,"DIA_Ralph_Past_04_15"); //Nigdy szczególnie o to nie zabiegalem i raczej nie mam zamiaru. Gdy by³em dzieckiem, uczy³em siê u stolarza.
	AI_Output (self, other,"DIA_Ralph_Past_04_16"); //Dziêki niemu umiem to co robiê dziœ. Paradoskalnie doceni³em uczciw¹ pracê fizyczn¹ tu w Kolonii.
};
