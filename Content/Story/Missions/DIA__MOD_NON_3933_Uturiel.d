...
FUNC VOID DIA_Uturiel_TondralStaff_Info()
{
	...
	AI_Output (self, other ,"DIA_Uturiel_TondralStaff_02_09"); //Z oczywistych przyczyn prze³êcz bêdziemy musieli omin¹æ ze wzglêdu na ciebie. Na pewno roi siê tam od ludzi króla.
...
FUNC VOID DIA_Uturiel_Book_Info()
{
    ...
    AI_Output (self, other ,"DIA_Uturiel_Book_03_02");  //Co ciê do mnie sprowadza m³odzieñcze?
    AI_Output (other, self ,"DIA_Uturiel_Book_15_03");  //Poszukuje pewnej ksiêgi . Nazywa siê ,,Potêga Magicznych Kryszta³ów,,.
	AI_Output (self, other ,"DIA_Uturiel_Book_03_04");  //Przeczyta³em j¹ wiêcej razy ni¿ mam w³osów na g³owie. Znam j¹ na pamiêæ.
	...
	AI_Output (other, self ,"DIA_Uturiel_Book_15_07");  //Czy móg³bym j¹ od ciebie odkupiæ?
	AI_Output (self, other ,"DIA_Uturiel_Book_03_08");  //Nie. Mogê ci j¹ daæ. Gardzê rud¹ jak¹ kolejn¹ odmian¹ ludzkiej waluty, która s³u¿y zwykle z³ym lub prostym celom.
	AI_Output (other, self ,"DIA_Uturiel_Book_15_09");  //Zatem daj mi proszê t¹ ksiêgê.
	AI_Output (self, other ,"DIA_Uturiel_Book_03_10");  //Nie tak prêdko ch³opczê. To, ¿e nie chcê rudy nie oznacza, ¿e nie chce niczego.
	AI_Output (other, self ,"DIA_Uturiel_Book_15_11");  //Zatem czego chcesz?
	AI_Output (self, other ,"DIA_Uturiel_Book_03_12");  //Kilka dni temu natkn¹³em siê na ohydnego potwora – jednego z Bagiennych Golemów.
	AI_Output (self, other ,"DIA_Uturiel_Book_03_13");  //Zaatakowa³ mnie a ja os³abi³em go magicznie. Jednak z r¹k wypad³ mi pewien magiczny kamieñ a ta bestia go po³knê³a przez jakiœ czas by³ dziêki temu odporny na moj¹ magiê.
	AI_Output (self, other ,"DIA_Uturiel_Book_03_14");  //Musia³em siê oddaliæ. Jednak chcia³bym ju¿ odzyskaæ tamten kamieñ.
	
	Info_ClearChoices 	(DIA_Uturiel_Book);
	Info_Addchoice 		(DIA_Uturiel_Book,"Gdzie znajdê tego Golema.",DIA_Uturiel_Kamien);
	
};

FUNC VOID DIA_Uturiel_Kamien ()
{
	AI_Output (other, self,"DIA_Uturiel_Kamien_15_01"); //Gdzie znajdê tego Golema?
	AI_Output (self, other,"DIA_Uturiel_Kamien_02_02"); //Przy jeziorku nieopodal st¹d, ko³o wielkiej wie¿y.
	AI_Output (other, self,"DIA_Uturiel_Kamien_15_03"); //Zatem odzyskam ten kamieñ.
	AI_Output (self, other,"DIA_Uturiel_Kamien_02_04"); //By³oby œwietnie.
	AI_StopProcessInfos	(self);
	B_LogEntry              (Kastragir,"Rozmawia³em z Magiem Uturielem. Jest zdecydowany daæ mi ksiêgê jednak najpierw muszê zmierzyæ siê z golemem, który w czasie walki z Uturielem rzekomo po³kn¹³ jego magiczny kamieñ. Muszê zabiæ tê istotê i odzyskaæ ten cenny przedmiot.");
...
{
    AI_Output (other, self ,"DIA_Uturiel_Golem_15_01");  //Mam twój kamieñ.
    AI_Output (self, other ,"DIA_Uturiel_Golem_03_02");  //Doskonale daj mi go proszê.
    AI_Output (other, self ,"DIA_Uturiel_Golem_15_03");  //Oto on.
	AI_Output (self, other ,"DIA_Uturiel_Golem_03_04");  //Dziêki m³odzieñcze. A teraz weŸ tê ksiêgê w dowód mojej wdziêcznoœci.
	AI_Output (other, self ,"DIA_Uturiel_Golem_15_05");  //Dziêkuje, Magu.
	B_GiveInvItems (other, self, ItMi_UturielStone,1);
	B_GiveInvItems (self, other, ItWr_UturielBook,1);
			B_LogEntry              (Kastragir,"Odda³em kamien Uturielowi za co ten podarowa³ mi ksiêgê, teraz muszê udaæ siê do Kastagira.");
};
...
INSTANCE DIA_Uturiel_KASTAGIR_DEAD (C_INFO)
{
   ...
   permanent	= FALSE;
   description  = "Mam tu pewien potê¿ny kryszta³ wype³niony z³¹ moc¹.";
};
...
{
    AI_Output (other, self ,"DIA_Uturiel_KASTAGIR_DEAD_15_01");  //Mam tu pewien potê¿ny kryszta³ wype³niony z³¹ moc¹. Trzeba go zniszczyæ.
    AI_Output (self, other ,"DIA_Uturiel_KASTAGIR_DEAD_03_02");  //Hmmm... Czujesz siê jakoœ inaczej od kiedy masz go w posiadaniu?
    AI_Output (other, self ,"DIA_Uturiel_KASTAGIR_DEAD_15_03");  //Raczej nie.
	AI_Output (self, other ,"DIA_Uturiel_KASTAGIR_DEAD_03_04");  //Zatem jesteœ jedn¹ z niewielu osób maj¹cych pewien rodzaj odpornoœci przed takimi artefaktami.
	AI_Output (other, self ,"DIA_Uturiel_KASTAGIR_DEAD_15_05");  //Zatem ten kryszta³ móg³by mnie zmieniæ? Chcê siê go natychmiast pozbyæ.
	AI_Output (self, other ,"DIA_Uturiel_KASTAGIR_DEAD_03_06");  //Daj mi go, proszê.
...
FUNC VOID DIA_Uturiel_KASTAGIR_DEAD1_Info()
{
    ...
    AI_Output (self, other ,"DIA_Uturiel_KASTAGIR_DEAD1_03_02");  //Wyczuwam w nim potê¿n¹ wewnêtrzn¹ si³ê w wiêkszoœci o z³ym zabarwieniu. To bez w¹tpienia potê¿ny artefakt.
    AI_Output (other, self ,"DIA_Uturiel_KASTAGIR_DEAD1_15_03");  //Przeprowadzisz teraz rytua³ by go zniszczyæ?
	AI_Output (self, other ,"DIA_Uturiel_KASTAGIR_DEAD1_03_04");  //Tak. 	
	AI_Output (self, other ,"DIA_Uturiel_KASTAGIR_DEAD1_03_05");  //O bogowie dajcie mi si³ê!
	AI_Output (self, other ,"DIA_Uturiel_KASTAGIR_DEAD1_03_06");  //Niechaj moc tego mrocznego kryszta³u odleci na zawsze!
	AI_Output (self, other ,"DIA_Uturiel_KASTAGIR_DEAD1_03_07");  //Niech stanie siê pusty by ca³a jego z³a moc przesta³a zagra¿aæ stworzeniom tej ziemi!
	...
	AI_Output (self, other ,"DIA_Uturiel_KASTAGIR_DEAD1_03_11");  //Gdyby tylko ludzie potrafili kontrolowaæ swoje s³aboœci i ¿¹dzê ten artefakt móg³by przyczyniæ siê tak¿e do dobrych rzeczy.
	AI_Output (self, other ,"DIA_Uturiel_KASTAGIR_DEAD1_03_12");  //Niestety cz³owiek to na swój sposób upoœledzony gatunek, pe³en ma³ostkowoœci i pychy.
	AI_Output (other, self ,"DIA_Uturiel_KASTAGIR_DEAD1_15_13");  //Dziêki za pomoc. Teraz jest bezpieczniej.
	...
	AI_Output (self, other ,"DIA_Uturiel_KASTAGIR_DEAD1_03_16");  //Niech Innos ma ciê w swojej opiece.
	AI_StopProcessInfos	(self);
	
	    B_LogEntry                     (Kastragir,"Mag Uturiel przeprowadzi³ stosowny rytua³ i zniszczy³ kryszta³ mocy. Teraz powinienem pogadaæ z Wilsonem i powiadomiæ go o sukcesie ostatniego przedsiêwziêcia.");
