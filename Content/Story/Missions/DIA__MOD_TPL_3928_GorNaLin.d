...
INSTANCE DIA_GorNaLin_HI_LIN (C_INFO)
{
   npc          = TPL_3928_GorNaLin;
   nr           = 1;
   condition    = DIA_GorNaLin_HI_LIN_Condition;
   information  = DIA_GorNaLin_HI_LIN_Info;
   permanent	= FALSE;
   description	= "Kim jesteœ?";
};

FUNC INT DIA_GorNaLin_HI_LIN_Condition()
{
    return TRUE;
};

FUNC VOID DIA_GorNaLin_HI_LIN_Info()
{
    AI_Output (other, self ,"DIA_GorNaLin_HI_LIN_15_01"); //Kim jesteœ?
    AI_Output (self, other ,"DIA_GorNaLin_HI_LIN_03_02"); //Gor Na aaaaa... Lin.
    AI_Output (other, self ,"DIA_GorNaLin_HI_LIN_15_03"); //Wojownik Œwi¹tynny?
    AI_Output (self, other ,"DIA_GorNaLin_HI_LIN_03_04"); //Taaatak mieecz Œni¹cegogo...
    AI_Output (self, other ,"DIA_GorNaLin_HI_LIN_03_05"); //Aleee tererazzz... Dadaj mi wódki!
    AI_Output (other, self ,"DIA_GorNaLin_HI_LIN_15_06"); //Chyba kiepsko z tob¹. I nie wiele siê od ciebie dowiem
    AI_Output (other, self ,"DIA_GorNaLin_HI_LIN_15_07"); //D³ugo tak nie poci¹gniesz.
    AI_Output (self, other ,"DIA_GorNaLin_HI_LIN_03_08"); //ZbubudŸ siê o Œni¹cycy! Nieniech œwiat poznana tw¹ potêgeeee aaaaaa...
