...
{
    AI_Output (self, other ,"DIA_Organisator_MAGE_QUEST_03_01"); //Podobno szukasz tych wkurzaj¹cych magików. Dobrze, bardzo dobrze. Mam doœæ tego ca³ego zamieszania. Widzia³em jednego jak bieg³ w kierunku rzeki.
    ...
    AI_Output (self, other ,"DIA_Organisator_MAGE_QUEST_03_03"); //Heh, tylko go dorwij!
	 B_LogEntry               (CH1_MagicySzkodnicy,"Stra¿nik bramy do nowego obozu powiedzia³ mi ¿e zauwa¿y³ jednego szkodnika biegn¹cego w kierunku rzeki, mo¿e to jakiœ trop?");
    B_GiveXP (60);
    AI_StopProcessInfos	(self);
};
//========================================
...
instance dia_org_829_pickpocket(c_info) {
    npc = org_829_organisator;
    nr = 900;
    condition = dia_org_829_pickpocket_condition;
    information = dia_org_829_pickpocket_info;
    permanent = 1;
    description = pickpocket_final;
};

func int dia_org_829_pickpocket_condition() {
	e_beklauen(baseThfChanceORG, 35);
};

func void dia_org_829_pickpocket_info() {
	b_steal_message();
	info_clearchoices(dia_org_829_pickpocket);
	info_addchoice(dia_org_829_pickpocket, dialog_back, dia_org_829_pickpocket_back);
	info_addchoice(dia_org_829_pickpocket, dialog_pickpocket, dia_org_829_pickpocket_doit);
};

func void dia_org_829_pickpocket_doit() {
    d_beklauen();
    info_clearchoices(dia_org_829_pickpocket);
};

func void dia_org_829_pickpocket_back() {
    info_clearchoices(dia_org_829_pickpocket);
};