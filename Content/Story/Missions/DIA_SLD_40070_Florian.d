...
FUNC VOID DIA_Florian_HELLO1_Info()
{
    ...
    AI_Output (self, other ,"DIA_Florian_HELLO1_03_02"); //Narazie tak. To cisza przed burz¹. 
    ...
    AI_Output (self, other ,"DIA_Florian_HELLO1_03_07"); //Niepotrzebnie o tym mówiê. Nie zdradzê ci wiêcej.
    ...
    AI_Output (other, self ,"DIA_Florian_HELLO1_15_10"); //W porz¹dku. Nie bêdê ju¿ dopytywa³.
};
...
FUNC VOID DIA_Florian_TMQ_ZOMBIE_Info()
{
    ...
    AI_Output (self, other ,"DIA_Florian_TMQ_ZOMBIE_03_02"); //Cz³owieku, nie wspominaj mi o tym! Do dzisiaj mam koszmary!
...
FUNC VOID DIA_Florian_KS_WHAT_Info()
{
    ...
    AI_Output (other, self ,"DIA_Florian_KS_WHAT_15_10"); //Zajmê siê tym.
    B_LogEntry                     (KuzniaStone,"Najemnik Florian chce siê dowiedzieæ, kto odpowiada za sk³ad personalny konwojów do Starej Kopalni. Nim zajmê siê dostêpem do kuŸni Stone’a, muszê o to popytaæ w Starym Obozie, najlepiej na zamku.");
...
FUNC VOID DIA_Florian_KS_COVOY_Info()
{
    ...
    AI_Output (self, other ,"DIA_Florian_KS_COVOY_03_07"); //Ach tak... Trzymaj.
    ...
    AI_Output (self, other ,"DIA_Florian_KS_COVOY_03_09"); //Tak. Oby potoczy³a siê dobrze.
	B_GiveXP(200);
...
FUNC VOID DIA_Florian_HI_FLORI_Info()
{
    ...
    AI_Output (self, other ,"DIA_Florian_HI_FLORI_03_05"); //Kiedyœ by³em szkodnikiem. Wpadam od czasu do czasu, przypomnieæ sobie dawne czasy.
    AI_Output (other, self ,"DIA_Florian_HI_FLORI_15_06"); //Mam wra¿enie, ¿e wola³byœ nadal byæ Szkodnikiem...
    AI_Output (self, other ,"DIA_Florian_HI_FLORI_03_07"); //Nie ukrywam, ¿e têsknie za tym. Mo¿e z czasem fucha najemnika mi siê spodoba.
};
...
FUNC VOID DIA_Florian_PZ_Info()
{
    ...
    AI_Output (self, other ,"DIA_Florian_PZ_03_02"); //Szed³em pogadaæ z Orikiem. Mia³em do niego jedn¹ sprawê.
    ...
    AI_Output (self, other ,"DIA_Florian_PZ_03_09"); //Jeden polecia³ w stronê bramy, drugi jakby zdêbia³. 
    AI_Output (self, other ,"DIA_Florian_PZ_03_10"); //Na mój widok wskoczy³ do wody i pop³yn¹³ na drug¹ stronê jeziora.
    AI_Output (other, self ,"DIA_Florian_PZ_15_11"); //Wielkie dziêki! Lecê siê z nimi rozprawiæ.
    AI_Output (self, other ,"DIA_Florian_PZ_03_12"); //Dobrze. Nie zabieram ci czasu. Zobaczê jak miewa siê Lee.
    AI_Output (other, self ,"DIA_Florian_PZ_15_13"); //Trzymaj siê.
