...
FUNC VOID DIA_Patrick_IanQuest_Info()
{
    ...
    AI_Output (other, self ,"DIA_Patrick_IanQuest_15_10"); //Wiesz, dok¹d móg³ siê udaæ?
...
{
    AI_Output (other, self ,"DIA_Patrick_Mine_15_01"); //S³ysza³em, ¿e w kopalni co rusz dochodzi do uszkodzeñ sprzêtu s³u¿¹cego do wydobycia.
    AI_Output (self, other ,"DIA_Patrick_Mine_03_02"); //Tak, a przez to Kopacze z kilofami musz¹ zasuwaæ dwa razy szybciej! 
    AI_Output (self, other ,"DIA_Patrick_Mine_03_03"); //Skoro ten sprzêt stale siê psuje to niech ci têpi Stra¿nicy rusz¹ siê do roboty i nam pomog¹!
    AI_Output (other, self ,"DIA_Patrick_Mine_15_04"); //Wiadomo ju¿ co planuj¹ Magnaci by wszystko wróci³o do normy?  
    AI_Output (self, other ,"DIA_Patrick_Mine_03_05"); //S³ysza³em, ¿e zamierzaj¹ tu przys³aæ swojego najlepszego in¿yniera. Ma on zarz¹dzaæ wykonaniem wszelkich napraw.
    AI_Output (other, self ,"DIA_Patrick_Mine_15_06"); //Dziêki za informacje!
  
    B_LogEntry                     (Zawirowania,"Patrick twierdzi, ¿e Magnaci znaleŸli remedium na swoje problemy. Chc¹ wys³aæ do kopalni swojego najlepszego in¿yniera by poczyni³ stosowne naprawy sprzêtu. Muszê o tym powiedzieæ Laresowi.");
...
INSTANCE DIA_Patrick_Potwor (C_INFO)
{
   ...
   permanent	= FALSE;
   description	= "Ponoæ widzia³eœ jakiegoœ stwora...";
};
...
{
    AI_Output (other, self ,"DIA_Patrick_Potwor_15_01"); //Ponoæ widzia³eœ jakiegoœ stwora grasuj¹cego nieopodal placu wymian.
    AI_Output (self, other ,"DIA_Patrick_Potwor_03_02"); //O tak! Widzia³em tego sukinsyna pewnej nocy gdy akurat ¿erowa³.
    AI_Output (self, other ,"DIA_Patrick_Potwor_03_03"); //Wielki dwuno¿ny gad. Stra¿nik Joel widzia³ kolejnego dnia zw³oki jakiegoœ nieszczêœnika zabitego przez to bydle.
    AI_Output (other, self ,"DIA_Patrick_Potwor_15_04"); //To cenna informacja. Dziêki za pomoc, pomówiê z Joelem.
    AI_Output (self, other ,"DIA_Patrick_Potwor_03_05"); //Zajmijcie siê tym cholerstwem nim po¿rê wiêcej osób.
    AI_Output (other, self ,"DIA_Patrick_Potwor_15_06"); //Jasne, ju¿ nad tym pracujemy.
  
    B_LogEntry                     (PotworBramus,"Patrick potwierdzi³, ¿e widzia³ potwora. To wielki gad. ¯erowa³ noc¹ gdy zosta³ zauwa¿ony. Nastêpnego dnia odnaleziono zmasakrowane zw³oki. Dokona³ tego stra¿nik Joel.");
...
INSTANCE DIA_Patrick_Life (C_INFO)
{
   ...
   permanent	= FALSE;
   description	= "Obi³o ci siê o uszy coœ o z³o¿ach kwarcytu?";
};
...
{
    AI_Output (other, self ,"DIA_Patrick_Life_15_01"); //Obi³o ci siê o uszy coœ o z³o¿ach kwarcytu?
    AI_Output (self, other ,"DIA_Patrick_Life_03_02"); //Mo¿liwe, ¿e siê obi³o ale, ¿eby siê upewniæ, ¿e tak by³o chcia³bym zobaczyæ 100 bry³ek rudy.
    AI_Output (self, other ,"DIA_Patrick_Life_03_03"); //Taka informacja kosztuje.
    AI_Output (other, self ,"DIA_Patrick_Life_15_04"); //Mog³em siê tego spodziewaæ.
    AI_Output (self, other ,"DIA_Patrick_Life_03_05"); //Takie ¿ycie...
    B_LogEntry(CennyKwarcyt ,"Patrick z obozowiska przed Star¹ Kopalni¹ zdaje siê coœ wiedzieæ na temat kwarcytu jednak bêdzie chcia³ za informacjê 100 bry³ek rudy.");
...
FUNC VOID DIA_Patrick_New_Camp_Quartz_Info()
{
    ...
    AI_Output (self, other ,"DIA_Patrick_New_Camp_Quartz_03_02"); //Dziêki. Ciekawa sprawa z tym kwarcytem. Szukano tego minera³u po ca³ej kolonii a okaza³o siê, ¿e niewielkie z³o¿e znajduje siê tu w kopalni.
    AI_Output (self, other ,"DIA_Patrick_New_Camp_Quartz_03_03"); //By³o dosyæ ma³e i szybko je wydobyto. Potem przygotowano do transportu do Starego obozu ale wtedy...
    ...
    AI_Output (other, self ,"DIA_Patrick_New_Camp_Quartz_15_05"); //Cholera, czyli trzeba go szukaæ go gdzieœ w nowym obozie.
    AI_Output (self, other ,"DIA_Patrick_New_Camp_Quartz_03_06"); //Na to wychodzi. Pewnie te brudne kundle ju¿ siê opijaj¹ za rude jak¹ dostali za ten ca³y ³adunek.
    AI_Output (other, self ,"DIA_Patrick_New_Camp_Quartz_15_07"); //Dziêki za informacje, zatem muszê udaæ siê do Nowego obozu. Trzymaj siê.
    AI_Output (self, other ,"DIA_Patrick_New_Camp_Quartz_03_08"); //Na twoim miejscu da³by sobie spokój bo ju¿ po herbacie ale jak chcesz to popytaj, mo¿e odzyskasz parê sztuk kwarcytu.
    ...
    B_LogEntry                     (CennyKwarcyt ,"Patrick odp³atnie stwierdzi³, ¿e odnaleziono ma³e z³o¿e kwarcytu w Starej Kopalni. Jednak gdy przygotowano go do transportu, zosta³ on noc¹ skradziony przez Szkodników z Nowego Obozu. Muszê siê tam udaæ i wypytaæ w odpowiednim miejscu kogoœ kto ma du¿o informacji. Myœlê, ¿e tamtejsza karczma to dobre miejsce.");
