...
FUNC VOID DIA_Skaza_RAPORT_Info()
{
    ...
    AI_Output (self, other ,"DIA_Skaza_RAPORT_03_28"); //Proponujê, ¿ebyœ pogada³ z Bartholo. To on opiekuje siê rzeczami Magnatów.
    AI_Output (other, self ,"DIA_Skaza_RAPORT_15_29"); //Mo¿e nie zauwa¿y³eœ, ale nie mogê wejœæ do zamku...
    AI_Output (self, other ,"DIA_Skaza_RAPORT_03_30"); //Dogadaj siê z jak¹œ wp³ywow¹ osob¹ w Obozie. Mo¿e ktoœ ci pomo¿e?
	AI_Output (self, other ,"DIA_Skaza_RAPORT_03_31"); //Poci¹gnij te¿ za jêzyk Kopaczy mieszkaj¹cych w okolicach chaty Z³ego. 
...
FUNC VOID DIA_Skaza_PART2_Info()
{
    ...
    AI_Output (other, self ,"DIA_Skaza_PART2_15_03"); //Tak. O jego grzeszkach wiedzia³a dosyæ du¿a liczba Kopaczy. Jednak jego siepacze skutecznie pilnowali, ¿eby nikt niczego siê nie dowiedzia³.
