...
INSTANCE DIA_Joel_Potwor (C_INFO)
{
   npc          = GRD_7006_Joel;
   nr           = 2;
   condition    = DIA_Joel_Potwor_Condition;
   information  = DIA_Joel_Potwor_Info;
   permanent	= FALSE;
   description	= "Ponoæ widzia³eœ zmasakrowane zw³oki przez wielk¹ bestiê...";
};

FUNC INT DIA_Joel_Potwor_Condition()
{
   if (Npc_KnowsInfo (hero, DIA_Patrick_Potwor))
   {
		return TRUE;
   };
};

FUNC VOID DIA_Joel_Potwor_Info()
{
   AI_Output(other, self, "DIA_Joel_Potwor_15_00"); //Ponoæ widzia³eœ zmasakrowane zw³oki przez wielk¹ bestiê grasuj¹c¹ w pobli¿u placu wymian.
   AI_Output(self, other, "DIA_Joel_Potwor_04_01"); //O tak. Poniek¹d s¹dzi³em, ¿e to bujdy wymyœlone przez kopaczy by wykrêciæ siê od pracy ale...
   AI_Output(self, other, "DIA_Joel_Potwor_04_02"); //Tak zmasakrowane zw³oki to musia³o byæ dzie³o nie lada potwora.
   AI_Output(self, other, "DIA_Joel_Potwor_04_03"); //S¹dzê, ¿e rzeczywiœcie to by³ ten wielki gad o, którym mówi³ Patrick.
   AI_Output(other, self, "DIA_Joel_Potwor_15_04"); //Czyli potwierdzasz jego opinie. Muszê pomówiæ z Thorusem.
   AI_Output(self, other, "DIA_Joel_Potwor_04_05"); //Poœpieszcie siê nim bêdzie wiêcej ofiar.
   
   
   
   B_LogEntry      (PotworBramus, "Joel jest pewny, ¿e to wielki gad zabi³ cz³owieka, którego widzia³ zw³oki. Wszystko uk³ada siê w logiczn¹ ca³oœæ. Muszê pomówiæ o tym z Thorusem.");
