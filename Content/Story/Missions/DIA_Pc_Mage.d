...
FUNC VOID DIA_pc_mage_PODAREK_MILTEN_Info()
{
	...
	AI_Output (self, other ,"DIA_pc_mage_PODAREK_MILTEN_03_07"); //WeŸ tê potê¿n¹ miksturê. Znalaz³em je przypadkiem w œwi¹tyni Magów Ognia.
	...
	B_LogEntry                     (CH4_4Friends,"Milten da³ mi miksturê many. Jedn¹ z najpotêrzniejszych mikstur zwiêkszaj¹c¹ si³ê duchow¹.");
   // AI_StopProcessInfos	(self);
};
...
{
      AI_Output (self, other ,"DIA_PC_MAGE_PRZESYLKA_03_01"); //Wzywa ciê arcymistrz Corristo!
      AI_Output (other, self ,"DIA_PC_MAGE_PRZESYLKA_15_02"); //Wiesz, czego ode mnie chce?
      AI_Output (self, other ,"DIA_PC_MAGE_PRZESYLKA_03_03"); //Nie ale to ponoæ pilna sprawa. Powinieneœ siê z nim niezw³ocznie zobaczyæ.
	  AI_Output (other, self ,"DIA_PC_MAGE_PRZESYLKA_15_04"); //Tak zrobiê.
   
    Log_CreateTopic          (PrzesylkaCorristo , LOG_MISSION);
    Log_SetTopicStatus       (PrzesylkaCorristo , LOG_RUNNING);
    B_LogEntry               (PrzesylkaCorristo ,"Milten powiedzia³, ¿e wzywa mnie Corristo. Ponoæ to coœ naprawdê wa¿nego.");
...
FUNC VOID DIA_PC_MAGE_JADRO_Info()
{
	  ...
	  AI_Output (self, other ,"DIA_PC_MAGE_JADRO_03_05"); //Wiêc udaj siê do Grahama i odbierz mapê. Potem idŸ zgodnie z ni¹ do celu.
	  AI_Output (other, self ,"DIA_PC_MAGE_JADRO_15_06"); //Tak zrobiê.
...
{
    AI_Output (self, other ,"DIA_PC_MAGE_HELLO1_03_01"); //S³ysza³eœ nowinê?!
    AI_Output (other, self ,"DIA_PC_MAGE_HELLO1_15_02"); //Jak¹?
    AI_Output (self, other ,"DIA_PC_MAGE_HELLO1_03_03"); //Jeden z Magów Wody – Cronos zosta³ zaatakowany pewnym ognistym zaklêciem.
    AI_Output (other, self ,"DIA_PC_MAGE_HELLO1_15_04"); //Ooo...
    AI_Output (self, other ,"DIA_PC_MAGE_HELLO1_03_05"); //A lodowy golem, którego przyzwa³ do obrony zosta³ ³atwo zniszczony.
    AI_Output (self, other ,"DIA_PC_MAGE_HELLO1_03_06"); //Zwyk³y opryszek nie mia³by takiego czaru. Trop wiedzie tylko do nas.
    AI_Output (self, other ,"DIA_PC_MAGE_HELLO1_03_07"); //Sêk w tym, ¿e nie mamy z tym nic wspólnego.
    ...
    AI_Output (self, other ,"DIA_PC_MAGE_HELLO1_03_10"); //Ta œwinia ewidentnie chcia³a sk³óciæ oba krêgi Magów. Przebieg³y drañ.
    AI_Output (other, self ,"DIA_PC_MAGE_HELLO1_15_11"); //Có¿... Racja.
	 Npc_RemoveInvItems (Grd_40062_John, ItMi_BLA_ZWOJ,1);
	B_LogEntry               (Blachostka,"Milten przekaza³ mi bardzo z³e wieœci. Jeden z Magów Wody – Cronos zosta³ zaatakowany. A lodowy golem, którego przyzwa³ do obrony zosta³ stopiony przy pomocy ,,Klingi Ognia”. To unikalne zaklêcie, które ukrad³em dla Johna. Ten drañ za tym wszystkim stoi. Chyba mam z nim do pogadania...");
    AI_StopProcessInfos	(self);
};
...
FUNC VOID DIA_PC_MAGE_Zjawa_Info()
{
    ...
    AI_Output (self, other ,"DIA_PC_MAGE_Zjawa_03_02"); //Myœla³em, ¿e to wymys³y podpitych kopaczy...
    AI_Output (other, self ,"DIA_PC_MAGE_Zjawa_15_03"); //Chyba jednak to prawda. Jeden z nich rozkopa³ pewien grób i ukrad³ z niego medalion. Myœlê, ¿e to wywo³a³o ca³y problem.
    AI_Output (self, other ,"DIA_PC_MAGE_Zjawa_03_04"); //Skoro tak mówisz to chyba powinienem ci zaufaæ.
    AI_Output (other, self ,"DIA_PC_MAGE_Zjawa_15_05"); //Mam ten medalion, mo¿e wystarczy go odnieœæ na miejsce.
    AI_Output (self, other ,"DIA_PC_MAGE_Zjawa_03_06"); //Nie, ju¿ za póŸno. Jeœli ta zjawa zosta³a ju¿ wywo³ana to trzeba j¹ unicestwiæ orê¿em.
    AI_Output (other, self ,"DIA_PC_MAGE_Zjawa_15_07"); //Hmm... Czyli bez rozwi¹zania si³owego siê nie obejdzie.
    AI_Output (self, other ,"DIA_PC_MAGE_Zjawa_03_08"); //Pogadaj z Grimem. Niech zaprowadzi ciê wieczorem do miejsca gdzie le¿y ten grób. Tam powinieneœ zobaczyæ z czym mamy do czynienia.
    AI_Output (self, other ,"DIA_PC_MAGE_Zjawa_03_09"); //Uwa¿aj bo ten o¿ywieniec móg³ przywo³aæ do pomocy kolejnych.
    AI_Output (other, self ,"DIA_PC_MAGE_Zjawa_15_10"); //Zrobiê tak jak mówisz.
    AI_Output (other, self ,"DIA_PC_MAGE_Zjawa_15_11"); //Na razie.
    AI_Output (self, other ,"DIA_PC_MAGE_Zjawa_03_12"); //Do zobaczenia.
	B_LogEntry               (Zjawa,"Milten twierdzi, ¿e nale¿y pokonaæ zjawê mieczem, za póŸno ju¿ na zwyk³e oddanie medalionu umar³ym. Grim musi noc¹ zaprowadziæ mnie na miejsce sk¹d zabra³ medalion.");
    AI_StopProcessInfos	(self);
};
...
INSTANCE DIA_PC_MAGE_ZL_BOOK (C_INFO)
{
   ...
   permanent	= FALSE;
   description	= "Mam pewn¹ dziwn¹ ksiêgê zapisan¹ w nieznanym mi jêzyku.";
};
...
{
    AI_Output (other, self ,"DIA_PC_MAGE_ZL_BOOK_15_01"); //Mam pewn¹ dziwn¹ ksiêgê zapisan¹ w nieznanym mi jêzyku.
    AI_Output (self, other ,"DIA_PC_MAGE_ZL_BOOK_03_02"); //Hmm... To ciekawe. Mogê j¹ obejrzeæ?
    AI_Output (other, self ,"DIA_PC_MAGE_ZL_BOOK_15_03"); //Oto ona.
	B_GiveInvItems (other,self, ItWr_ZL_Sattik, 1);
    AI_Output (self, other ,"DIA_PC_MAGE_ZL_BOOK_03_04"); //Dziwnie to wygl¹da. Móg³bym to przet³umaczyæ. Kiedyœ mia³em stycznoœæ z dawnymi dialektami.
    AI_Output (other, self ,"DIA_PC_MAGE_ZL_BOOK_15_05"); //Ile ci zajmie przet³umaczenie tej ksiêgi?
	...
	B_LogEntry               (KsiegaDlaVictora,"Da³em Miltenowi ksiêgê, teraz muszê poczekaæ 2 dni a¿ j¹ przet³umaczy na znany nam wszystkim jêzyk.");
    AI_StopProcessInfos	(self);
};
