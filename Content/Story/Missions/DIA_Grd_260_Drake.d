...
FUNC VOID DIA_Drake_DOK_Info()
{
    ...
    AI_Output (self, other ,"DIA_Drake_DOK_03_03"); //O cholera. Czyli wkrótce nowa dostawa? W takim razie przechodŸ.
    AI_StopProcessInfos	(self);
};
...
FUNC VOID DIA_Drake_DWMN_END_Info()
{
    ...
    AI_Output (other, self ,"DIA_Drake_DWMN_END_15_04"); //Po prostu dosta³em zadanie I wyœledzi³em co mi kazano. To nic osobistego.
    AI_Output (self, other ,"DIA_Drake_DWMN_END_03_05"); //Masz szczêœcie. Ale wejdŸ mi w drogê jeszcze raz a gorzko tego po¿a³ujesz.
    AI_Output (other, self ,"DIA_Drake_DWMN_END_15_06"); //Jak nie bêdziesz robi³ nikomu co tobie nie mi³e to nie bêdzie potrzeby.
    AI_Output (self, other ,"DIA_Drake_DWMN_END_03_07"); //Zdolny jesteœ. Ale pamietaj o tym co powiedzia³em.
	B_LogEntry               (Dywersant,"Drake pogrozi³ mi palcem za to, ¿e wykry³em jego intrygê. Po prostu zrobi³em co mi kazali a on niech nie próbuje podobnych brudnych gierek.");
    AI_StopProcessInfos	(self);
};
