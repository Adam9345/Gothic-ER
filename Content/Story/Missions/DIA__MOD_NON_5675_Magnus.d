...
INSTANCE DIA_Magnus_HI_ZD_BEER (C_INFO)
{
   npc          = NON_5675_Magnus;
   nr           = 1;
   condition    = DIA_Magnus_HI_ZD_BEER_Condition;
   information  = DIA_Magnus_HI_ZD_BEER_Info;
   permanent	= FALSE;
   description	= "Mam dla ciebie coœ od Silasa.";
};

FUNC INT DIA_Magnus_HI_ZD_BEER_Condition()
{
if (Npc_KnowsInfo(hero,DIA_Silas_ZD_CRATES))
&& (Npc_HasItems (other, ItMi_ZDCRATE) >=1)
{
    return TRUE;
};
};
FUNC VOID DIA_Magnus_HI_ZD_BEER_Info()
{
    AI_Output (other, self ,"DIA_Magnus_HI_ZD_BEER_15_01"); //Mam dla ciebie coœ od Silasa.
    AI_Output (self, other ,"DIA_Magnus_HI_ZD_BEER_03_02"); //Mi³o, ¿e wci¹¿ pamiêta o moim istnieniu. Co to takiego?
    AI_Output (other, self ,"DIA_Magnus_HI_ZD_BEER_15_03"); //Skrzynka dobrego piwa.
    AI_Output (self, other ,"DIA_Magnus_HI_ZD_BEER_03_04"); //Œwietnie. Nie ma to jak starannie wywa¿one piwo.
    AI_Output (other, self ,"DIA_Magnus_HI_ZD_BEER_15_05"); //Masz t¹ skrzynkê. Jeœli wolno spytaæ za co ten upominek?
    AI_Output (self, other ,"DIA_Magnus_HI_ZD_BEER_03_06"); //Zapewne przez wzgl¹d na dawne czasy. Niegdyœ dorabia³em sobie poluj¹c I zanosz¹c pozyskane miêso do Silasa.
    AI_Output (self, other ,"DIA_Magnus_HI_ZD_BEER_03_07"); //Mia³ sta³e zapotrzebowanie a ja nieŸle na tym zarabia³em. Ale potem mieliœmy sprzeczkê I wspó³praca wygas³a.
    AI_Output (self, other ,"DIA_Magnus_HI_ZD_BEER_03_08"); //Skoro wys³a³ mi ten podarek to pewnie ju¿ trochê mu przesz³o. To hardy I ostry ale uczciwy cz³owiek w gruncie rzeczy.
    AI_Output (other, self ,"DIA_Magnus_HI_ZD_BEER_15_09"); //Rozumiem. Wracam do Silasa bo muszê ubiæ z nim targu w pewnej sprawie.
	B_GiveInvItems (other,self,  ItMi_ZDCRATE, 1);
