...
FUNC VOID DIA_Emanuel_HELLO_Info()
{
    ...
    AI_Output (self, other ,"DIA_Emanuel_HELLO_03_04"); //Ano prawda. Sprzedajê tak¿e ¿ywnoœæ. Interesuje ciê coœ?
...
FUNC VOID DIA_Emanuel_QUEST1_Info()
{
    ...
    AI_Output (self, other ,"DIA_Emanuel_QUEST1_03_06"); //Z niczym bardziej skomplikowanym byœ sobie nie poradzi³.
...
FUNC VOID DIA_Emanuel_RAYAN_Info()
{
    ...
    AI_Output (self, other ,"DIA_Emanuel_RAYAN_03_02"); //Nic konkretnego. Wyszed³ pewnego wieczoru, a nastêpnego dnia znaleziono go martwego z drobnymi obra¿eniami.
...
{
    if (Npc_GetTrueGuild (hero) == GIL_GOBBO)
    {
    return TRUE;
    };
};
...
FUNC VOID DIA_Emanuel_REPUTACJA_Info()
{
    ...
    AI_Output (self, other ,"DIA_Emanuel_REPUTACJA_03_05"); //Nawet sobie nie wyobra¿asz jak te œwiêtoszki potrafi¹ pochlaæ! No, ale do rzeczy. 
    ...
    AI_Output (self, other ,"DIA_Emanuel_REPUTACJA_03_08"); //Mam teraz du¿o roboty, wiêc nie mogê pójœæ na spotkanie. Dam ci towar, a ty dokonasz za mnie wymiany. 
    ...
    AI_Output (self, other ,"DIA_Emanuel_REPUTACJA_03_15"); //Starkad go czasem wysy³a, gdy podobnie jak ja dzisiaj, nie ma czasu. No, mo¿esz iœæ. Powodzenia.
    ...
    B_LogEntry               (CH1_EmanuelsDeals,"Emanuel kaza³ mi spotkaæ siê z jego kontrahentem z Obozu Bractwa w jaskini na lewo od przejœcia na Ziemie Orków pilnowanego przez Stra¿ników. Muszê odebraæ 400 bry³ek rudy i przekazaæ 30 sztuk miêsa, oraz 5 zup.");
...
{
    AI_Output (other, self ,"DIA_Emanuel_RUDAOK_15_01"); //Mam sakiewkê z rud¹. Niestety po drodze natkn¹³em siê na k³opoty.
    AI_Output (self, other ,"DIA_Emanuel_RUDAOK_15_02"); //Jakie znowu k³opoty? Ju¿ mia³em ci dziêkowaæ.
	AI_Output (other, self ,"DIA_Emanuel_RUDAOK_15_03"); //Nie masz siê czego obawiaæ. Mam rudê, jednak Shine nie ¿yje. 
    AI_Output (self, other ,"DIA_Emanuel_RUDAOK_03_04"); //Jak to? Nie by³o Starkada?
	AI_Output (other, self ,"DIA_Emanuel_RUDAOK_15_05"); //Nie, gdy zjawi³em siê w jaskini le¿a³ tam martwy Shine i jakiœ inny Nowicjusz. 
	...
	AI_Output (self, other ,"DIA_Emanuel_RUDAOK_03_09"); //Musieli wiedzieæ o wymianie. Cholera, szkoda Shine'a jak diabli. Powiedz o tym Starkadowi, jeœli jeszcze tego nie zrobi³eœ.
