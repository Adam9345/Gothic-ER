...
INSTANCE DIA_Stone_Klucz (C_INFO)
{
   ...
   permanent	= FALSE;
   description	= "Mam klucz do twojej kuŸni. Bierz.";
};
...
{
    AI_Output (other, self ,"DIA_Stone_Klucz_15_01"); //Mam klucz do twojej kuŸni. Bierz. 
    AI_Output (self, other ,"DIA_Stone_Klucz_03_02"); //Co takiego?! Przecie¿ klucz do mojej starej kuŸni zagin¹³ wieki temu!
	AI_Output (other, self ,"DIA_Stone_Klucz_15_03"); //Ale oto siê znalaz³. Odzyska³em go od pewnego cz³owieka w Nowym Obozie.
	B_GiveInvItems (other, self, ItKe_Stone_Kuznia, 1);
    AI_Output (self, other ,"DIA_Stone_Klucz_03_04"); //To tam go wywia³o! Mog³em siê domyœliæ!
	AI_Output (other, self ,"DIA_Stone_Klucz_15_05"); //Tamtejsi ludzie uwielbiaj¹ cudze przedmioty...
	AI_Output (self, other ,"DIA_Stone_Klucz_03_06"); //Racja. Jestem ci bardzo wdziêczny. Powinienem jakoœ to okazaæ.
	AI_Output (self, other ,"DIA_Stone_Klucz_03_07"); //WeŸ ten miecz w nagrodê, to dobre ostrze. Z pewnoœci¹ ci siê przyda.
	B_GiveInvItems (self,other, ITMW_1H_GRD_BASTARD, 1);
	AI_Output (other, self ,"DIA_Stone_Klucz_15_08"); //Dziêki. 
	AI_Output (self, other ,"DIA_Stone_Klucz_03_09"); //Trzymaj siê ch³opczê.
	AI_Output (other, self ,"DIA_Stone_Klucz_15_10"); //Ty równie¿. 
	B_GiveXP (500);

	
	B_LogEntry                     (KuzniaStone,"Odda³em klucz Stone’owi. By³ tyle¿ uradowany co zaskoczony, otrzyma³em od niego ciekawie wygl¹daj¹cy miecz. Do tego ten dziwny b³ysk w jego oku... Myœlê ¿e mo¿e byæ coœ na rzeczy, Na razie zatrzymam tê broñ. Buster i Gilbert bêd¹ musieli obejœæ siê smakiem.");
...
FUNC VOID DIA_Stone_LearnSmith_01_Info()
{
    ...
    AI_Output (other, self ,"DIA_Stone_LearnSmith_01_15_01"); //Mo¿esz mnie czegoœ nauczyæ?
    AI_Output (self, other ,"DIA_Stone_LearnSmith_01_03_02"); //Nie mam czasu na uczenie cie podstaw. Naucz siê czegoœ i dopiero zawracaj mi g³owê.
...
FUNC VOID DIA_Stone_LearnSmith_02_Info()
{
    ...
    if  (hero.lp >= 10) 
	{
    AI_Output (other, self ,"DIA_Stone_LearnSmith_02_15_01"); //Naucz mnie jak wykuæ dobry miecz. 
    AI_Output (self, other ,"DIA_Stone_LearnSmith_02_03_02"); //Podstawy ju¿ znasz, to dobrze. Teraz czas na coœ trudniejszego...
    AI_Output (self, other ,"DIA_Stone_LearnSmith_02_03_03"); //Gdy uderzasz w gor¹c¹ stal staraj siê robiæ to z wyczuciem i nie b¹dŸ spiêty.
    AI_Output (self, other ,"DIA_Stone_LearnSmith_02_03_04"); //Najwa¿niejsze, jest to byœ nie uderza³ zbyt mocno, albo za lekko...
    AI_Output (self, other ,"DIA_Stone_LearnSmith_02_03_05"); //Poza tym, wszystko zale¿y od ciebie i rodzaju broni, jak¹ chcesz wykonaæ.
	...
	{
	AI_Output (self,other ,"DIA_Stone_LearnSmith_02_03_06"); //Brak ci doœwiadczenia.
...
INSTANCE DIA_Stone_Velaya (C_INFO)
{
   ...
   permanent	= FALSE;
   description	= "Móg³byæ zatroszczyæ siê o t¹ kobietê? Uratowa³em j¹ przed pijanymi Stra¿nikami.";
};
...
{
    AI_Output (other, self ,"DIA_Stone_Velaya_15_01"); //Móg³byœ zatroszczyæ siê o Velayê? Uratowa³em j¹ przed pijanymi Stra¿nikami.
    AI_Output (self, other ,"DIA_Stone_Velaya_03_02"); //Oczywiœcie. Nie by³bym wierny sobie gdybym post¹pi³ inaczej.
    AI_Output (self, other ,"DIA_Stone_Velaya_03_03"); //Poza tym mi pomog³eœ. Zajmê siê ni¹ do czasu gdy wszystko  siê uspokoi. 
    AI_Output (other, self ,"DIA_Stone_Velaya_15_04"); //Równy z ciebie goœæ. W³aœnie o chcia³em us³yszeæ. Dziêkuje!
    AI_Output (self, other ,"DIA_Stone_Velaya_03_05"); //Drobiazg.
	Npc_ExchangeRoutine(EBR_108_Velaya,"StoneSit");
	B_LogEntry               (VelayaWNiebezbieczenstwie,"Stone' a zaopiekuje siê Velay¹ póki sytuacja siê nie uspokoi. Mam nadzieje, ¿e oboje przetrwaj¹ t¹ burze. Teraz mogê zaj¹æ siê innymi sprawami nie ciepi¹cymi zw³oki.");
