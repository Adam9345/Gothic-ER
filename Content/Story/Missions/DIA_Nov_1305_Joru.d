...
FUNC VOID DIA_Joru_SecretBook_Info()
{
    ...
    AI_Output (self, other ,"DIA_Joru_SecretBook_03_02"); //Co? Sk¹d masz mój notatnik?!
...
FUNC VOID DIA_Joru_ORE_Info()
{
    ...
    AI_Output (other, self ,"DIA_Joru_ORE_15_03"); //Najpierw jad³eœ, to teraz p³aæ. A poza tym nie zgrywaj cwaniaka, bo zaraz inaczej pogadamy.
...
FUNC VOID DIA_Joru_ParvezInTroubles_Info()
{
	...
	AI_Output(self, other, "DIA_Joru_ParvezInTroubles_03_04"); //Nasze Bractwo potrzebuje nowych wyznawców, tak jak ziemia nasion by daæ owocny plon.
...
{
    AI_Output (other, self ,"DIA_Joru_ORE1_15_01"); //Przysy³a mnie Brago. Poczu³ moc duchow¹ Œni¹cego, chcia³by z tob¹ o tym porozmawiaæ.
    AI_Output (self, other ,"DIA_Joru_ORE1_03_02"); //Dziwne. Nagle ten zapijaczony gbur postanowi³ pójœæ drog¹ Œni¹cego? Ale ka¿da okazja jest dobra. Pogadam z nim.   
	//AI_StopProcessInfos	(self);
...
INSTANCE DIA_Joru_MEDALION (C_INFO)
{
   ...
   permanent	= FALSE;
   description	= "Masz tu swój medalion.";
};
...
{
    AI_Output (other, self ,"DIA_Joru_MEDALION_15_01"); //Masz tu swój medalion.
    AI_Output (self, other ,"DIA_Joru_MEDALION_03_02"); //Ten, który mi ukrad³eœ.
    AI_Output (other, self ,"DIA_Joru_MEDALION_15_03"); //Tak, pope³ni³em b³¹d, przepraszam. Ale naprawi³em go zabieraj¹c skradzione rzeczy Brago, który zabi³ Mosula.
	AI_Output (self, other ,"DIA_Joru_MEDALION_03_04"); //Przyjmuje przeprosiny. Ale nastêpnym razem nie zbaczaj ze œwietlanej drogi sprawiedliwoœci Œni¹cego bo to bywa niebezpieczne!
...
INSTANCE DIA_Joru_WHY_YOUGET_REP (C_INFO)
{
   ...
   permanent	= FALSE;
   description	= "Jak uda³o ci siê zdobyæ tak dobr¹ reputacjê u Guru?";
};
...
{
    AI_Output (other, self ,"DIA_Joru_WHY_YOUGET_REP_15_01"); //Jak uda³o ci siê zdobyæ tak dobr¹ reputacjê u Guru?
    AI_Output (self, other ,"DIA_Joru_WHY_YOUGET_REP_03_02"); //Ci¹g³¹ prac¹ nad sob¹ w aspekcie duchowym.
    AI_Output (other, self ,"DIA_Joru_WHY_YOUGET_REP_15_03"); //A coœ wiêcej?
    AI_Output (self, other ,"DIA_Joru_WHY_YOUGET_REP_03_04"); //Na pocz¹tku by³em po prostu przyk³adnym uczniem. PóŸniej wykonywa³em coraz wa¿niejsze polecenia moich mistrzów.
    AI_Output (self, other ,"DIA_Joru_WHY_YOUGET_REP_03_05"); //Studiowa³em te¿ stare ksiêgi by zg³êbiaæ sw¹ wiedzê. To pozwoli³o mi na powa¿niejsze konwersacje z Guru.
    AI_Output (self, other ,"DIA_Joru_WHY_YOUGET_REP_03_06"); //Takie wejœcie w dyskusje a nawet polemikê bardzo poszerza horyzonty wiedzy na temat funkcjonowania wszelkich spraw.
    AI_Output (self, other ,"DIA_Joru_WHY_YOUGET_REP_03_07"); //Zw³aszcza ceni³em sobie rozmowy z Baalem Cadarem. 
    AI_Output (other, self ,"DIA_Joru_WHY_YOUGET_REP_15_08"); //Domyœlam siê, ¿e macie dobre relacje?
    AI_Output (self, other ,"DIA_Joru_WHY_YOUGET_REP_03_09"); //Baal Cadar to mój wielki duchowy przewodnik. A tak¿e przyjaciel. 
    AI_Output (other, self ,"DIA_Joru_WHY_YOUGET_REP_15_10"); //W porz¹dku. Dziêki za informacje.
};
