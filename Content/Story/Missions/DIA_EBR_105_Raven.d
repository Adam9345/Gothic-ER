...
INSTANCE DIA_Raven_ZaplataZaWolnosc (C_INFO)
{
   ...
   permanent	= FALSE;
   description	= "Chcê, ¿ebyœ go wypuœci³. (Uwolnij Alexa - 1000 bry³ek rudy)";
};
...
FUNC VOID DIA_Raven_LSZ_Adolf_Info()
{
    ...
    AI_Output (self, other ,"DIA_Raven_LSZ_Adolf_03_02"); //A kto to do cholery jest? I czemu akurat mi zawracasz tym g³owê?!
    AI_Output (other, self ,"DIA_Raven_LSZ_Adolf_15_03"); //S³ysza³em, ¿e jeden z was?
    AI_Output (self, other ,"DIA_Raven_LSZ_Adolf_03_04"); //Masz na myœli jakiegoœ nowego kopacza? 
    AI_Output (other, self ,"DIA_Raven_LSZ_Adolf_15_05"); //Nie, chodzi o Magnata.
    AI_Output (self, other ,"DIA_Raven_LSZ_Adolf_03_06"); //Hahah... Ubawi³eœ mnie. Jestem tu na tyle d³ugo, ¿eby kojarzyæ pozosta³ych Magnatów hehe...
    AI_Output (self, other ,"DIA_Raven_LSZ_Adolf_03_07"); //Nie BY£O i NIE MA wœród nas nikogo o tym imieniu.
    AI_Output (other, self ,"DIA_Raven_LSZ_Adolf_15_08"); //Wiedzia³em...
    AI_Output (self, other ,"DIA_Raven_LSZ_Adolf_03_09"); //Ale jeœli naprawdê szukasz kogoœ takiego w obozie to pomów z Gravo. On zna WSZYSTKICH.
    AI_Output (other, self ,"DIA_Raven_LSZ_Adolf_15_10"); //Dziêki za radê.
    AI_Output (self, other ,"DIA_Raven_LSZ_Adolf_03_11"); //Nastêpnym razem nie zawracaj mi g³owy takimi bzdurami, a teraz idŸ ju¿.
	B_LogEntry               (LatwySzmal,"Kruk wyœmia³ mnie mówi¹c, ¿e nie ma ¿adnego Magnata od imieniu Adolf. Poleci³ mi pogadaæ z Gravo. O co w tym chodzi?");
    AI_StopProcessInfos	(self);
};
