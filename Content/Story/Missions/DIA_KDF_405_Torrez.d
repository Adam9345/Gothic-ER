...
FUNC VOID  DIA_Torrez_Belohnung_Info()
{
	...
	Info_AddChoice		(DIA_Torrez_Belohnung,"Chcia³bym dostaæ ten napój!(Max Mana +4)" 	,DIA_Torrez_Belohnung_ManaMax);
...
INSTANCE DIA_Torrez_Brandick_amulett (C_INFO)
{
   ...
   permanent	= FALSE;
   description	= "Witaj Magu. Czy móg³bym....";
};
...
{
    AI_Output (other, self ,"DIA_Torrez_Brandick_amulett_15_01"); //Witaj Magu. Czy móg³bym...
    AI_Output (self, other ,"DIA_Torrez_Brandick_amulett_03_02"); //Dlaczego mi przeszkadzasz?! W³aœnie dog³êbnie analizowa³em wa¿n¹ sprawê a ty wybi³eœ mnie z myœli.
    ...
    AI_Output (self, other ,"DIA_Torrez_Brandick_amulett_03_05"); //S¹dz¹c po twoim nonszalanckim tonie nazwanie ciê ma³o ukulturalnionym wa³koniem to ogromne niedopowiedzenie i niewspó³mierna ³aska.
    AI_Output (other, self ,"DIA_Torrez_Brandick_amulett_15_06"); //CO Proszê?
    AI_Output (self, other ,"DIA_Torrez_Brandick_amulett_03_07"); //Skoro ju¿ mi przeszkodzi³eœ to poka¿ mi to z czym powa¿y³eœ siê do mnie przyjœæ.   

	 Info_ClearChoices (DIA_Torrez_Brandick_amulett);
	 Info_AddChoice    (DIA_Torrez_Brandick_amulett,"Oto medalion o, którym mówi³em.",DIA_Torrez_Brandick_amulett1);	
};


FUNC VOID DIA_Torrez_Brandick_amulett1()
  {
	AI_Output (other,self ,"DIA_Torrez_Brandick_amulett1_15_00");  //Oto medalion o, którym mówi³em.
	AI_Output (self ,other,"DIA_Torrez_Brandick_amulett1_11_01");  //Chyba mam coœ co powinno tutaj pasowaæ. Ale ten kamieñ magiczny jest wart co najmniej 130 bry³ek rudy.
	AI_Output (self ,other,"DIA_Torrez_Brandick_amulett1_11_02");  //Albo mi tyle dasz albo mo¿esz to sobie zabraæ i raczyæ zejœæ mi z oczu.
    B_GiveInvItems (other, self, Amulett_BrandickS_02, 1);	
	B_LogEntry               (CiekaweZnalezisko,"Uda³em siê do Magów Ognia celem zdobycia magicznego kamienia do medalionu. Torrez mo¿e mi go sprzedaæ jednak ¿¹da 130 bry³ek rudy. Poza tym jest wyj¹tkowo arogancki. Ten stary grzyb to chyba ,,najsympatyczniejszy” cz³owiek jakiego spotka³em pod barier¹. Nie licz¹c tych, z którymi musia³em skrzy¿owaæ broñ.");
};
...
INSTANCE DIA_Torrez_Brandick_krysztal (C_INFO)
{
   ...
   permanent	= FALSE;
   description	= "Oto 130 bry³ek, tak jak chcia³eœ Magu.";
};
...
{
    AI_Output (other, self ,"DIA_Torrez_Brandick_krysztal_15_01"); //Oto 130 bry³ek, tak jak chcia³eœ Magu.
	Npc_RemoveInvItem	(KDF_405_Torrez, Amulett_BrandickS_02);
    AI_Output (self, other ,"DIA_Torrez_Brandick_krysztal_03_02"); //Zgoda. W³o¿y³em kamieñ w pasuj¹ce miejsce medalionu, idealnie pasuje trzeba przyznaæ.
    AI_Output (self, other ,"DIA_Torrez_Brandick_krysztal_03_03"); //Wobec tego weŸ to.
    AI_Output (other, self ,"DIA_Torrez_Brandick_krysztal_15_04"); //Dziêkuje za pomoc.
    AI_Output (self, other ,"DIA_Torrez_Brandick_krysztal_03_05"); //I jeszcze jedno. Nastêpnym razem nie zawracaj mojej zafrasowanej g³owy takimi bzdurami!
    AI_Output (other, self ,"DIA_Torrez_Brandick_krysztal_15_06"); //Postaram siê...
