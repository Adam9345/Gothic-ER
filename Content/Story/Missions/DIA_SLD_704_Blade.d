...
FUNC VOID DIA_Blade_HELLO1_Info()
{
	...
	{
	AI_Output (self, other ,"DIA_Blade_HELLO1_03_20"); //Nic siê jeszcze nie zaczê³o. Czekamy na odpowiedni moment. PrzyjdŸ póŸniej. 
...
//   About Recruit
////////////////////////////////////////////////
INSTANCE DIA_Blade_Defend_NC (C_INFO)
{
   ...
   npc          = SLD_704_Blade;
   nr           = 1;
   condition    = DIA_Blade_Defend_NC_Condition;
   information  = DIA_Blade_Defend_NC_Info;
   permanent	= FALSE;
   description	= "Niedaleko obozu znajduj¹ siê stra¿nicy Gomeza.";
   
   
   
};

FUNC INT DIA_Blade_Defend_NC_Condition()
{
...
FUNC VOID DIA_Blade_Defend_NC_Info()
{
