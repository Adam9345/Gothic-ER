...
{
    AI_Output (other, self ,"DIA_Josep_LeftRiceLord_15_01"); //Zmywajmy siê st¹d. 
    AI_Output (self, other ,"DIA_Josep_LeftRiceLord_03_02"); //Nareszcie! ChodŸ za mn¹. Pójdziemy razem do obozu myœliwych. 
    AI_Output (other, self ,"DIA_Josep_LeftRiceLord_15_03"); //Lewus chyba coœ kombinuje, kaza³ mi czekaæ jeden dzieñ nim mi cie wyda.
    AI_Output (self, other ,"DIA_Josep_LeftRiceLord_03_04"); //Faktycznie odrobinê to podejrzane, nie traæmy wiêc czasu. W drogê.
