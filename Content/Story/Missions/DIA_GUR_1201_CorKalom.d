...
FUNC VOID DIA_CorKalom_MessengerIngredients_Info()
{
    ...
    AI_Output (self, other ,"DIA_CorKalom_MessengerIngredients_03_03"); //A wiêc wszystko gotowe. Spotkajmy siê na placu œwi¹tynnym. Jest tam ma³y o³tarz. Myœlê, ¿e wystarczy. 
...
FUNC VOID DIA_CorKalom_AfterParty_Info()
{
	...
	{
	AI_Output (other, self ,"DIA_CorKalom_AfterParty_05_14"); //Jestem cz³onkiem obozu Quentina, w¹tpiê ¿e stra¿nicy dobrowolnie mnie wpuszcz¹ do kopalni...
	AI_Output (self, other ,"DIA_CorKalom_AfterParty_03_15"); //Có¿...
	  B_UseFakeScroll( );  
	AI_Output (self, other ,"DIA_CorKalom_AfterParty_03_16"); //W razie problemów poka¿ ten list stra¿nikom, nie powinni sprawiaæ problemów.
