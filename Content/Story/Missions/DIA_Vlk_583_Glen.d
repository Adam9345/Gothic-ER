...
INSTANCE DIA_Glen_Silver_Nugget (C_INFO)
{
   ...
   permanent	= FALSE;
   description	= "Ponoæ jesteœ w posiadaniu minera³u zwanego srebrnym gromem.";
};
...
{
    AI_Output (other, self ,"DIA_Glen_Silver_Nugget_15_01"); //Ponoæ jesteœ w posiadaniu minera³u zwanego srebrnym gromem.
    ...
    AI_Output (self, other ,"DIA_Glen_Silver_Nugget_03_09"); //Odsprzeda³em minera³ handlarzowi Alberto za odpowiedni¹ sumê.
    AI_Output (other, self ,"DIA_Glen_Silver_Nugget_15_10"); //Rozumiem.
	AI_Output (other, self ,"DIA_Glen_Silver_Nugget_15_11"); //Nie bêdê ci ju¿ zabiera³ czasu. Idê do tego handlarza.
	...
	AI_Output (other, self ,"DIA_Glen_Silver_Nugget_15_13"); //Na razie.
	 ...
	 B_LogEntry               (MieczGorBoby,"Rozmawia³em z Glenem. Odsprzeda³ on swój cenny kruszec handlarzowi Alberto.");
...
{
    AI_Output (other, self ,"DIA_Glen_DWMN_MAMCIE_15_01"); //Mam ciê ptaszku!
    ...
    AI_Output (self, other ,"DIA_Glen_DWMN_MAMCIE_03_06"); //Zmusili mnie. Ja nie chcia³em tego robiæ.
    AI_Output (other, self ,"DIA_Glen_DWMN_MAMCIE_15_07"); //Kto ciê zmusi³?
    AI_Output (self, other ,"DIA_Glen_DWMN_MAMCIE_03_08"); //Ulbert. Ale taki têpak nie mo¿e byæ mózgiem tej operacji.
    AI_Output (self, other ,"DIA_Glen_DWMN_MAMCIE_03_09"); //Ktoœ chcê ewidentnie usun¹æ Iana z jego stanowiska.
    AI_Output (other, self ,"DIA_Glen_DWMN_MAMCIE_15_10"); //Ciekawe. IdŸ do Iana I powiedz mu to co powiedzia³eœ mi. Ja pogadam z Ulbertem.
    AI_Output (self, other ,"DIA_Glen_DWMN_MAMCIE_03_11"); //W porz¹dku. Tylko niech ju¿ nikt mnie nie bije...
	B_LogEntry               (Dywersant,"Glen próbowa³ zrobiæ coœ z gór¹ rudy. Ale jest on tylko wykonawc¹ misji do, której ponoæ zmusi³ go Ulbert. Muszê z nim pogadaæ ");
