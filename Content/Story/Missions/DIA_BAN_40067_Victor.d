...
FUNC VOID DIA_Victor_ZL_Info()
{
    ...
    AI_Output (self, other ,"DIA_Victor_ZL_03_04"); //Ja nie mogê przenikn¹æ do Starego Obozu, wyt³uk³em ju¿ zbyt wielu ludzi stamt¹d i mnie pamiêtaj¹.
...
INSTANCE DIA_Victor_ZL_DROGA (C_INFO)
{
   ...
   permanent	= FALSE;
   description	= "Gdzie moja nagroda?";
};
...
{
    AI_Output (other, self ,"DIA_Victor_ZL_DROGA_15_01"); //Gdzie moja nagroda?
    AI_Output (self, other ,"DIA_Victor_ZL_DROGA_03_02"); //Dobra choæ za mn¹. Nie trzymam jej w obozie.
    AI_Output (other, self ,"DIA_Victor_ZL_DROGA_15_03"); //Tylko bez ¿adnych sztuczek.
...
FUNC VOID DIA_Victor_ZL_PRAY_Info()
{
    ...
    AI_Output (self, other ,"DIA_Victor_ZL_PRAY_03_02"); //Przynios³em ci dar, który zaraz otrzymasz. 
    AI_Output (self, other ,"DIA_Victor_ZL_PRAY_03_03"); //Ju¿ czas zar¿n¹æ ofiarê!
	CreateInvItems (self, ItWr_ZL_Book, 1);
    AI_Output (other, self ,"DIA_Victor_ZL_PRAY_15_04"); //Ty durny pajacu...
    AI_Output (self, other ,"DIA_Victor_ZL_PRAY_03_05"); //Sattik jest g³odny twej krwi!
...
FUNC VOID DIA_Victor_HELLO1_Info()
{
    ...
    AI_Output (self, other ,"DIA_Victor_HELLO1_03_02"); //Mam na imiê Victor. Szczerze mówi¹c trochê siê nudzê. 
    ...
    AI_Output (self, other ,"DIA_Victor_HELLO1_03_06"); //Nie interesuj sie...
