...
FUNC VOID DIA_PC_Thief_Quartz_Info()
{
    ...
    AI_Output (self, other ,"DIA_PC_Thief_Quartz_03_01"); //Mam do ciebie sprawê. Myœlê, ¿e jesteœ gotów by jej podo³aæ.
    AI_Output (other, self ,"DIA_PC_Thief_Quartz_15_02"); //O co chodzi?
    AI_Output (self, other ,"DIA_PC_Thief_Quartz_03_03"); //Magowie Ognia wykorzystuj¹ minera³ zwany kwarcytem do ró¿nych badañ i obrzêdów magicznych.
	AI_Output (self, other ,"DIA_PC_Thief_Quartz_03_04"); //Sprowadzanie tego surowca spoza Bariery jest drogie i czasoch³onne do tego na konwoje czêsto napadaj¹ Bandyci lub Szkodnicy i ³adunek przepada.
	AI_Output (self, other ,"DIA_PC_Thief_Quartz_03_05"); //Potencjalne wydobycie tego surowca w kolonii by³oby bardzo intratne.
	AI_Output (self, other ,"DIA_PC_Thief_Quartz_03_06"); //Trzeba by tylko odnaleŸæ jego z³o¿ê. I tu pojawia siê twoja rola.
	AI_Output (other, self ,"DIA_PC_Thief_Quartz_15_07"); //Co mia³bym zrobiæ?
	AI_Output (self, other ,"DIA_PC_Thief_Quartz_03_08"); //Udaæ siê do obozowiska pod star¹ kopalni¹ i wypytaæ czy nie obi³a siê komuœ o uszy informacja o z³o¿ach kwarcytu.
	AI_Output (other, self ,"DIA_PC_Thief_Quartz_15_09"); //Mogê siê tam pojawiæ i popytaæ kogo trzeba.
	AI_Output (self, other ,"DIA_PC_Thief_Quartz_03_10"); //I tego w³aœnie od ciebie oczekuje. Jeœli za³atwisz tê sprawê mo¿esz liczyæ na moj¹ wdziêcznoœæ.
	AI_Output (other, self ,"DIA_PC_Thief_Quartz_15_11"); //Dobrze. Zagl¹dnê gdzie trzeba i postaram siê za³atwiæ te sprawê. 
	AI_Output (other, self ,"DIA_PC_Thief_Quartz_15_12"); //A póki co trzymaj siê.
	...
	B_LogEntry			(CennyKwarcyt ,"Diego jest zainteresowany minera³em zwanym kwarcytem. Magowie Ognia wykorzystuj¹ go do ró¿nych badañ. Chcia³by on odnaleŸæ jakieœ jego z³o¿ê w Kolonii. Poleci³ mi bym uda³ siê do obozowiska przed Star¹ Kopalni¹ i zasiêgn¹³ jêzyka u tamtejszych bywalców.");
};
...
FUNC VOID DIA_PC_Thief_Quartz1_Info()
{
    ...
    AI_Output (self, other ,"DIA_PC_Thief_Quartz1_03_02"); //Œwietnie. Dotar³eœ do jakiegoœ wiêkszego z³o¿a?
	AI_Output (other, self ,"DIA_PC_Thief_Quartz1_15_03"); //To d³uga historia. 
	AI_Output (self, other ,"DIA_PC_Thief_Quartz1_03_04"); //Opowiadaj œmia³o.
	AI_Output (other, self ,"DIA_PC_Thief_Quartz1_15_05"); //W starej kopalni odnaleziono niewielkie z³o¿e kwarcytu i wydobyto go. 
	AI_Output (other, self ,"DIA_PC_Thief_Quartz1_15_06"); //Jednak póŸniej ludzie Laresa napadli na obóz przed kopalni¹ i go ukradli nim go wys³ano.
	AI_Output (other, self ,"DIA_PC_Thief_Quartz1_15_07"); //Musia³em udaæ siê do Nowego Obozu, po pewnych perypetiach dowiedzieæ siê gdzie go ukryli a potem wyrolowaæ i gwizdn¹æ ca³y kwarcyt.
	AI_Output (self, other ,"DIA_PC_Thief_Quartz1_03_08"); //Jestem pod wra¿eniem. Stale siê rozwijasz i s¹ tego efekty, jesteœ pojêtnym uczniem.
	AI_Output (other, self ,"DIA_PC_Thief_Quartz1_15_09"); //Oto zdobyty kwarcyt.
	B_GiveInvItems (other,self, ItMi_Quartz, 40);
	AI_Output (self, other ,"DIA_PC_Thief_Quartz1_03_10"); //Dziêkuje. Mi³o jest patrzeæ z boku na to jak stale idziesz do przodu. Coraz bardziej rozumiesz wszelkie uk³ady i prawid³a jakie panuj¹ w Kolonii.
	AI_Output (other, self ,"DIA_PC_Thief_Quartz1_15_11"); //Mam dobrych nauczycieli w tym ciebie.
	AI_Output (self, other ,"DIA_PC_Thief_Quartz1_03_12"); //Pamiêtaj, ¿e nie pomagam ka¿demu. A tylko tym, którzy na to zas³uguj¹.
	AI_Output (other, self ,"DIA_PC_Thief_Quartz1_15_13"); //S³usznie robisz. A póki co trzymaj siê, wkrótce znów pogadamy.
    AI_Output (self, other ,"DIA_PC_Thief_Quartz1_03_14"); //Do zobaczenia, bêdê ciê mia³ na oku.
	B_GiveXP(400);
	
    MIS_CennyKwarcyt = LOG_SUCCESS;
    B_LogEntry			(CennyKwarcyt ,"Wróci³em do Diego ze zdobytym kwarcytem. Opowiedzia³ o przygodach jakie mnie spotka³y. Diego by³ ze mnie zadowolony i wyp³aci³ mi nagrodê. Zdaje siê, ¿e mocno zyska³em w jego oczach.");
...
INSTANCE DIA_PC_Thief_ZL_RITUAL (C_INFO)
{
   ...
   permanent	= FALSE;
   description	= "Pewien cz³owiek chce bym da³ mu dziwna ksiêgê.";
};
...
{
    AI_Output (other, self ,"DIA_PC_Thief_ZL_RITUAL_15_01"); //Pewien cz³owiek chcê bym da³ mu dziwna ksiêgê. Zapewne chodzi o jakieœ ciemne rytua³y.
    AI_Output (self, other ,"DIA_PC_Thief_ZL_RITUAL_03_02"); //Co jest w niej zapisane?
    AI_Output (other, self ,"DIA_PC_Thief_ZL_RITUAL_15_03"); //Nie wiem. To jakiœ dawny jêzyk, tak mi siê wydaje.
    AI_Output (self, other ,"DIA_PC_Thief_ZL_RITUAL_03_04"); //Tutaj powinni pomóc Magowie Ognia. Pomów z, którymœ z nich. Najlepiej z Miltenem.
    AI_Output (other, self ,"DIA_PC_Thief_ZL_RITUAL_15_05"); //Dziêki za radê. Ta sprawa mocno œmierdzi.
    AI_Output (self, other ,"DIA_PC_Thief_ZL_RITUAL_03_06"); //Nie ma za co. Widzê, ¿e masz sporo na g³owie.
...
{
    AI_Output (other, self ,"DIA_PC_Thief_Othnielia_15_01"); //Mam pewn¹ sprawê.
    AI_Output (self, other ,"DIA_PC_Thief_Othnielia_03_02"); //Jaka¿ to sprawa?
    AI_Output (other, self ,"DIA_PC_Thief_Othnielia_15_03"); //Mówi ci coœ imiê Othnielia?
    AI_Output (self, other ,"DIA_PC_Thief_Othnielia_03_04"); //To zamordowana ¿ona króla Rhobara! Gdzie s³ysza³eœ to imiê?
    AI_Output (other, self ,"DIA_PC_Thief_Othnielia_15_05"); //Eee... Niewa¿ne.
    AI_Output (self, other ,"DIA_PC_Thief_Othnielia_03_06"); //Ta œmieræ do dzisiaj owiana jest mg³¹ tajemnicy. Ponoæ to przywódca najemników w nowym obozie Lee by³ w to zamieszany.
    AI_Output (self, other ,"DIA_PC_Thief_Othnielia_03_07"); //Ale ja szczerze w¹tpiê, ¿e to on by³ inicjatorem lub wykonawc¹ tej zbrodni.
    AI_Output (other, self ,"DIA_PC_Thief_Othnielia_15_08"); //Dziêki za informacjê.
    AI_Output (self, other ,"DIA_PC_Thief_Othnielia_03_09"); //Nie ma za co. A i jeszcze jedno. Nie rozpowiadaj, ¿e wiesz coœ na temat zabójstwa królewskiej ¿ony. To mo¿e przynieœæ ci k³opoty.
    AI_Output (other, self ,"DIA_PC_Thief_Othnielia_15_10"); //Dziêki za radê!
	 B_LogEntry               (ZaDlugiJezor,"Diego powiedzia³, ¿e Othnielia by³a ¿on¹ króla Rhobara! Wiedzia³em, ¿e sk¹dœ kojarzê to imiê. A wiêc Norton zamordowa³ ¿onê króla... Tymczasem Diego poleci³ mi bym nikomu nie rozpowiada³, ¿e wiem coœ na ten temat. Wspomina³ coœ o Lee. Tak czy siak na razie powinienem zostaæ cicho.");
	Zdj_day = Wld_GetDay();
    AI_StopProcessInfos	(self);
};
...
{
    AI_Output (self, other ,"DIA_Pc_Thief_Murder_Zdj_03_01"); //Cholera, w co siê znowu wpakowa³eœ?
    AI_Output (other, self ,"DIA_Pc_Thief_Murder_Zdj_15_02"); //Ja? Niby czemu?
    AI_Output (self, other ,"DIA_Pc_Thief_Murder_Zdj_03_03"); //Szuka ciê goœæ, w ciemnej zbroi.
    AI_Output (other, self ,"DIA_Pc_Thief_Murder_Zdj_15_04"); //Czego ode mnie chce?
    AI_Output (self, other ,"DIA_Pc_Thief_Murder_Zdj_03_05"); //Nie mam pojêcia ale nie wygl¹da na takiego co chcia³by napiæ siê z tob¹ piwa.
    AI_Output (other, self ,"DIA_Pc_Thief_Murder_Zdj_15_06"); //Gdzie teraz jest?
    AI_Output (self, other ,"DIA_Pc_Thief_Murder_Zdj_03_07"); //Stoi przy bramie do obozu, chyba naprawdê mu zale¿y ¿eby siê z tob¹ "spotkaæ".
    AI_Output (other, self ,"DIA_Pc_Thief_Murder_Zdj_15_08"); //W takim razie zajrzê do niego.
    AI_Output (self, other ,"DIA_Pc_Thief_Murder_Zdj_03_09"); //B¹dŸ ostro¿ny.
...
{
    AI_Output (self, other ,"DIA_Pc_Thief_HERO_IS_STT_03_01"); //A wiêc ci siê powiod³o. Szczerze mówi¹c choæ Gomez jest nieobliczalny nie spodziewa³em siê innego obrotu spraw.
    AI_Output (self, other ,"DIA_Pc_Thief_HERO_IS_STT_03_02"); //Podj¹³eœ s³uszn¹ decyzjê. Mam nadzieje, ¿e do³¹czaj¹c do Cieni bêdziesz siê czu³ dobrze.
    AI_Output (self, other ,"DIA_Pc_Thief_HERO_IS_STT_03_03"); //Ale te¿ nie przestaniesz siê dalej rozwijaæ. Nie mo¿na przecie¿ staæ w miejscu.
    AI_Output (other, self ,"DIA_Pc_Thief_HERO_IS_STT_15_04"); //Rozumiem. Mi³o, ¿e jesteœ zadowolony z mojego przyjêcia w poczet twoich podkomendnych.
    AI_Output (other, self ,"DIA_Pc_Thief_HERO_IS_STT_15_05"); //Liczê, ¿e przys³u¿ê siê spo³ecznoœci tego obozu. Ale I zyskam nieco rudy przy okazji.
    AI_Output (self, other ,"DIA_Pc_Thief_HERO_IS_STT_03_06"); //Maj¹c g³owê na karku zyskasz wp³ywy I nie bêdziesz musia³ martwiæ siê o rudê.
    AI_Output (other, self ,"DIA_Pc_Thief_HERO_IS_STT_15_07"); //To dobrze. By³bym rad gdyby w miêdzyczasie nikt nie pos³a³ mnie do piachu.
    AI_Output (self, other ,"DIA_Pc_Thief_HERO_IS_STT_03_08"); //Jeœli bêdziesz mieæ szeroko otwarte oczy I uszy to prze¿yjesz. Cieñ musi mieæ wyczulone zmys³y.
    AI_Output (other, self ,"DIA_Pc_Thief_HERO_IS_STT_15_09"); //Rozumiem. Tak czy owak chyba podj¹³em dobr¹ decyzje staj¹c siê jednym z ludzi Gomeza... Przynajmniej na razie.
};
...
{
    AI_Output (self, other ,"DIA_Pc_Thief_HERO_IS_GRD_03_01"); //No proszê nie przestajesz pi¹æ siê w górê. 
    AI_Output (self, other ,"DIA_Pc_Thief_HERO_IS_GRD_03_02"); //Minê³a chwila i ju¿ jesteœ w Stra¿y Gomeza.
    AI_Output (other, self ,"DIA_Pc_Thief_HERO_IS_GRD_15_03"); //Wypadki id¹ coraz szybciej. Mam nadzieje, ¿e to bêdzie udana przygoda. I przyniesie rudê.
    AI_Output (self, other ,"DIA_Pc_Thief_HERO_IS_GRD_03_04"); //Obyœ siê nie myli³. Póki co Stary Obóz oferuje sporo i trzeba siê z nim liczyæ.
    AI_Output (self, other ,"DIA_Pc_Thief_HERO_IS_GRD_03_05"); //A co do rudy to nawet dobrze, ¿e jest marzeniem ka¿dego pod barier¹....
    AI_Output (other, self ,"DIA_Pc_Thief_HERO_IS_GRD_15_06"); //Co masz na myœli?
    AI_Output (self, other ,"DIA_Pc_Thief_HERO_IS_GRD_03_07"); //To, ¿e dziêki temu ³atwiej zaopatrzyæ siê w inne cenne zasoby, czego nie omieszkam uczyniæ.
    AI_Output (other, self ,"DIA_Pc_Thief_HERO_IS_GRD_15_08"); //Hmm...Ciekawe mam nadzieje, ¿e kiedyœ opowiesz mi o tym wiêcej!
    AI_Output (self, other ,"DIA_Pc_Thief_HERO_IS_GRD_03_09"); //Dobrze. Jeœli tylko Bogowie pozwol¹. No i powodzenia w szeregach Stra¿ników.
    AI_Output (other, self ,"DIA_Pc_Thief_HERO_IS_GRD_15_10"); //Dziêki.
    AI_StopProcessInfos	(self);
};
