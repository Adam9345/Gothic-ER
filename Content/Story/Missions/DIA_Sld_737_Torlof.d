...
FUNC VOID DIA_Torlof_GiveAxe_Info()
{
	...
	//PrintS_Ext ("Szybka podró¿ odblokowana!",COL_White) ;
};
...
INSTANCE DIA_Torlof_HELLO1233 (C_INFO)
{
   ...
   permanent	= FALSE;
     description	= "Lee kaza³ zaj¹æ siê obozowiskiem stra¿ników ze Starego Obozu...";
};
...
{
    AI_Output (other, self ,"DIA_Torlof_HELLO1233_15_00");   //Lee kaza³ zaj¹æ siê obozowiskiem stra¿ników ze Starego Obozu. Na ich czele stoi niejaki Morok.
    AI_Output (self, other ,"DIA_Torlof_HELLO1233_03_01");   //S³ysza³em. Jeœli chodzi o mnie to jestem gotowy do wymarszu.
    AI_Output (other, self ,"DIA_Torlof_HELLO1233_15_02");   //Dobra.
    AI_Output (self, other ,"DIA_Torlof_HELLO1233_03_03");   //Daj znaæ kiedy ruszamy.
...
{
    AI_Output (other, self ,"DIA_Torlof_AAA_15_00");   //W drogê.
...
FUNC VOID DIA_Torlof_AAAS_Info()
{
    ...
    AI_Output (self, other ,"DIA_Torlof_AAAS_15_00");   //Pos³uchaj. Wkrótce na nich uderzymy. Wa¿ne by oszczêdziæ dwóch stra¿ników, którzy stoj¹ na czele tego oddzia³u.
    AI_Output (self, other ,"DIA_Torlof_AAAS_15_01");   //To Morok i Patter. Musimy dowiedzieæ siê od nich co ze zrabowanymi towarami.
	B_LogEntry                     (Obozowisko,"Dotarliœmy pod obóz Moroka. Zaraz na nich uderzymy. Torlof powiedzia³, ¿eby oszczêdziæ Moroka i Pattera by dowiedzieæ siê od nich gdzie s¹ zrabowane towary.");
...
FUNC VOID DIA_Torlof_ZM_Camp_Info()
{
    ...
    AI_Output (other, self ,"DIA_Torlof_ZM_Camp_15_03"); //Gomez zamierza uderzyæ na obóz myœliwych. Trzeba im pomóc.
    AI_Output (self, other ,"DIA_Torlof_ZM_Camp_03_04"); //Pomogê wam skoro nadesz³a taka potrzeba. Zaczyna³em siê ju¿ nudziæ.
    AI_Output (other, self ,"DIA_Torlof_ZM_Camp_15_05"); //Dobra, spotkajmy siê przed obozem.
...
{
    AI_Output (self, other ,"DIA_Torlof_PZ_03_01"); //Hej m³ody. Wydarzy³o siê coœ dziwnego.
    AI_Output (other, self ,"DIA_Torlof_PZ_15_02"); //Co takiego?
    AI_Output (self, other ,"DIA_Torlof_PZ_03_03"); //Trzej Szkodnicy weszli do siedziby Lee. A potem dwóch z nich wybieg³o jak ra¿onych piorunem.
    AI_Output (self, other ,"DIA_Torlof_PZ_03_04"); //Zdawa³o siê, ¿e wiej¹ jak najdalej. Nie podoba mi siê to co zobaczy³em.
    AI_Output (self, other ,"DIA_Torlof_PZ_03_05"); //To by³o dos³ownie przed chwil¹. SprawdŸ co siê tam sta³o.
    AI_Output (other, self ,"DIA_Torlof_PZ_15_06"); //Dobrze pójdê tam.
    AI_Output (self, other ,"DIA_Torlof_PZ_03_07"); //Jak dowiesz siê co to mia³o znaczyæ to podziel siê t¹ wiedz¹.
	...
	B_LogEntry          (PodejrzaneZamieszanie,"Torlof zauwa¿y³ dziwne zachowanie paru ludzi wchodz¹cych a nastêpnie czym prêdzej uciekaj¹cych z siedziby Lee. Powinienem zajrzeæ do szefa Najemników.");
};
...
FUNC VOID DIA_Torlof_PZ_Zamach_Info()
{
    ...
    AI_Output (other, self ,"DIA_Torlof_PZ_Zamach_15_05"); //Tak. Ale pozostal dwaj uciekli a ja muszê ich œcigaæ. Sam Lee prosi³ mnie o to.
    AI_Output (self, other ,"DIA_Torlof_PZ_Zamach_03_06"); //Udaj siê w kierunku wyjœcia z wielkiej jaskini. Mo¿e znajdziesz jak¹œ wskazówkê co robiæ dalej.
    AI_Output (other, self ,"DIA_Torlof_PZ_Zamach_15_07"); //Taki mam zamiar.
    AI_Output (self, other ,"DIA_Torlof_PZ_Zamach_03_08"); //Zatem ruszaj. Szkoda strzêpiæ jêzyka póki ci gnoje jeszcze dychaj¹!
    AI_Output (other, self ,"DIA_Torlof_PZ_Zamach_15_09"); //Racja.
	B_LogEntry               (PodejrzaneZamieszanie,"Powiedzia³em Torlofowi co zasz³o. Zdenerwowany Najemnik radzi³ szybko ruszyæ œladem morderców Orika w stronê wyjœcia z wielkiej jaskini. Mo¿e znajdê tam jak¹œ poszlakê?");
