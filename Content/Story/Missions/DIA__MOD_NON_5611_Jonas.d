...
INSTANCE DIA_Jonas_ZM_Who (C_INFO)
{
   npc          = NON_5611_Jonas;
   nr           = 1;
   condition    = DIA_Jonas_ZM_Who_Condition;
   information  = DIA_Jonas_ZM_Who_Info;
   permanent	= FALSE;
   description	= "Co dok³adnie ciê sprowadza?";
};

FUNC INT DIA_Jonas_ZM_Who_Condition()
{
	if (Npc_KnowsInfo(hero,DIA_Lee_ZM_Hunter))
{
    return TRUE;
};
};
FUNC VOID DIA_Jonas_ZM_Who_Info()
{
    ...
    AI_Output (other, self ,"DIA_Jonas_ZM_Who_15_07"); //Masz racjê. Wiadomo ilu ich jest?
    AI_Output (self, other ,"DIA_Jonas_ZM_Who_03_08"); //Nie wiem bo Alex odprawia³ mnie bym od razu tu przybieg³.
