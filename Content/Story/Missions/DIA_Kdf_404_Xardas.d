...
{
	AI_Output			(other, self,"Info_Xardas_MAKERUNEDOIT_15_01"); //Chcê, ¿ebyœ usun¹³ klejnot z URIZIELA!
...
INSTANCE DIA_Xardas_BlackCrystals (C_INFO)
{
   npc          = KDF_404_Xardas;
   nr           = 7;
   condition    = DIA_Xardas_BlackCrystals_Condition;
   information  = DIA_Xardas_BlackCrystals_Info;
   permanent	= FALSE;
   important    = TRUE;
};

FUNC INT DIA_Xardas_BlackCrystals_Condition()
{
	if (kapitel == 5)
	{
    return TRUE;
...
FUNC VOID DIA_Xardas_BlackCrystals_Info()
{
    AI_Output (self, other ,"DIA_Xardas_BlackCrystals_03_01"); //Wedle informacji, które posiadam w œwi¹tyni pod miastem orków powinny znajdowaæ siê pewne cenne przedmioty.
    AI_Output (other, self ,"DIA_Xardas_BlackCrystals_15_02"); //Jakie?
    AI_Output (self, other ,"DIA_Xardas_BlackCrystals_03_03"); //Chodzi o czarne kryszta³y, zawieraj¹ce moc, któr¹ chcia³bym pozyskaæ i dok³adnie zbadaæ.
    AI_Output (self, other ,"DIA_Xardas_BlackCrystals_03_04"); //Z tego co mi wiadomo powinno byæ ich 7.
	AI_Output (self, other ,"DIA_Xardas_BlackCrystals_03_05"); //By³bym wdziêczny gdybyœ mi je przyniós³.
    AI_Output (other, self ,"DIA_Xardas_BlackCrystals_15_06"); //Spróbujê.
    AI_Output (self, other ,"DIA_Xardas_BlackCrystals_03_07"); //Jeszcze jedno, w pobli¿u kryszta³ów powinny krêciæ siê magiczne pantery. Te istoty przyci¹ga moc czarnych kryszta³ów.
	AI_Output (self, other ,"DIA_Xardas_BlackCrystals_03_08"); //Gdybyœ pozyska³ pazury tych magicznych istot, by³bym zadowolony.
	AI_Output (other, self ,"DIA_Xardas_BlackCrystals_15_09"); //Postaram siê je zdobyæ...
    AI_Output (other, self ,"DIA_Xardas_BlackCrystals_15_10"); //A w³aœciwie ile ich potrzebujesz?
    AI_Output (self, other ,"DIA_Xardas_BlackCrystals_03_11"); //Tuzin.
    AI_Output (other, self ,"DIA_Xardas_BlackCrystals_15_12"); //W porz¹dku.	
	Log_CreateTopic(CzarneKrysztaly,LOG_MISSION);
	Log_SetTopicStatus (CzarneKrysztaly,LOG_RUNNING);
	B_LogEntry (CzarneKrysztaly,"Xardas chcia³by ode mnie pewnej przys³ugi. Mianowicie bym zdoby³ dla niego w œwi¹tyni pod miastem orków magiczne kryszta³y wype³nione interesuj¹c¹ dla niego moc¹. Jest ich 7. W pobli¿u mogê spodziewaæ siê magicznych panter. Xardas chcia³by bym pozyska³ dla niego tuzin (12) pazurów tych magicznych stworzeñ.");
    AI_StopProcessInfos	(self);
...
INSTANCE DIA_Xardas_BlackCrystals_End (C_INFO)
{
   npc          = KDF_404_Xardas;
   nr           = 7;
   condition    = DIA_Xardas_BlackCrystals_End_Condition;
   information  = DIA_Xardas_BlackCrystals_End_Info;
   permanent	= FALSE;
   description    = "Mam kryszta³y.";
};

FUNC INT DIA_Xardas_BlackCrystals_End_Condition()
{
	if	Npc_KnowsInfo(hero, DIA_Xardas_BlackCrystals)
	&& (Npc_HasItems (other, ItMi_Black_Crystal_CH5) >=7) 
	&& (Npc_HasItems (other, ItAt_Puma_Claws) >=12)
	{
    return TRUE;
	};
};

FUNC VOID DIA_Xardas_BlackCrystals_End_Info()
{
    AI_Output (other, self ,"DIA_Xardas_BlackCrystals_End_15_01"); //Mam kryszta³y.
    AI_Output (self, other ,"DIA_Xardas_BlackCrystals_End_03_02"); //Œwietnie, daj mi je.
    AI_Output (other, self ,"DIA_Xardas_BlackCrystals_End_15_03"); //Proszê.
    AI_Output (self, other ,"DIA_Xardas_BlackCrystals_End_03_04"); //Bêdê móg³ wreszcie rozpocz¹æ nad nimi badania.
	AI_Output (self, other ,"DIA_Xardas_BlackCrystals_End_03_05"); //Dobrze siê spisa³eœ.
    AI_Output (self, other ,"DIA_Xardas_BlackCrystals_End_03_06"); //A co z pazurami magicznych panter?
    AI_Output (other, self ,"DIA_Xardas_BlackCrystals_End_15_07"); //Oto one.
	B_GiveInvItems (other,self,ItMi_Black_Crystal_CH5, 7);
	B_GiveInvItems (other,self, ItAt_Puma_Claws, 12);
	AI_Output (self, other ,"DIA_Xardas_BlackCrystals_End_03_08"); //Wspaniale. Przeanalizuje teraz ich magiczne w³aœciwoœci.
	AI_Output (self, other ,"DIA_Xardas_BlackCrystals_End_03_09"); //Oto twoja nagroda za okazany wysi³ek.
	B_GiveInvItems (self,other, ItArScrollArmyOfDarkness, 2);
	B_GiveInvItems (self,other, ItFo_Potion_Health_Perma_03, 1);
    AI_Output (other, self ,"DIA_Xardas_BlackCrystals_End_15_10"); //Dziêkuje.
	B_GiveXP(500);
	B_LogEntry (CzarneKrysztaly,"Odda³em Xardasowi 7 czarnych kryszta³ów i tuzin pazurów magicznych panter. Nekromanta by³ ze mnie zadowolony i wynagrodzi³ mnie.");

	Log_SetTopicStatus (CzarneKrysztaly,LOG_SUCCESS);
    AI_StopProcessInfos	(self);
...
INSTANCE DIA_Xardas_TWO (C_INFO)
{
   npc          = Kdf_404_Xardas;
   nr           = 1;
   condition    = DIA_Xardas_TWO_Condition;
   information  = DIA_Xardas_TWO_Info;
   permanent	= FALSE;
   Important    = TRUE;
};

FUNC INT DIA_Xardas_TWO_Condition()
{
if (Npc_KnowsInfo(hero,DIA_Hugo_TWO_Tablica))
&& (Npc_IsDead (Orc_ELite_TWO))
{
    return TRUE;
};
};
FUNC VOID DIA_Xardas_TWO_Info()
{
    AI_Output (self, other ,"DIA_Xardas_TWO_03_01"); //A wiêc przyby³eœ.
    AI_Output (other, self ,"DIA_Xardas_TWO_15_02"); //Jak widaæ.
    AI_Output (self, other ,"DIA_Xardas_TWO_03_03"); //Pytanie tylko sk¹d ci przeklêci Orkowie wziêli siê w mojej wie¿y.
    AI_Output (self, other ,"DIA_Xardas_TWO_03_04"); //Domyœlam siê, ¿e utworzono jakiœ teleport.
    AI_Output (other, self ,"DIA_Xardas_TWO_15_05"); //Przejeliœmy tablicê, na której Orkowie zapisali plan ataku na ciebie byœ nie pomóg³ mi w walce ze Œni¹cym.
    AI_Output (self, other ,"DIA_Xardas_TWO_03_06"); //Zatem muszê teraz odprawiæ rytua³.
    AI_Output (other, self ,"DIA_Xardas_TWO_15_07"); //Jaki?
    AI_Output (self, other ,"DIA_Xardas_TWO_03_08"); //Milcz!
	AI_PlayAni  (self,"T_MAGRUN_2_HEASHOOT");
	//Wld_PlayEffect("SPELLFX_TELEPORT",  self, self, 0, 0, 0, FALSE );
	AI_Output (self, other ,"DIA_Xardas_TWO_03_09"); //(Szepcze)...
	AI_PlayAni  (self,"T_HEASHOOT_2_STAND");
   
	B_LogEntry               (TajemniczaWiadomoscOrkow,"Zd¹rzy³em pomóc Xardasowi w ostatniej chwili Orkowie ju¿ byli w wie¿y gdy siê tam dosta³em. Na szczêœcie zabiliœmy ich. Teraz trzeba dowiedzieæ siê jak zniszczyæ ich portal.");
};
Func void TWO_ORC_SHA()
{
	Wld_InsertNpc				(Shaman_TWO_02,"WP_OSH_TWO1");
	Wld_InsertNpc				(Shaman_TWO_01,"WP_OSH_TWO2");
	Wld_InsertNpc				(OrcWarrior2,"WP_OSH_TWO3");
	Wld_InsertNpc				(OrcWarrior2,"WP_OSH_TWO4");
	Wld_InsertNpc				(OrcWarrior2,"WP_OSH_TWO5");
};
//========================================
//-----------------> TWO_Rytual
//========================================

INSTANCE DIA_Xardas_TWO_Rytual (C_INFO)
{
   npc          = Kdf_404_Xardas;
   nr           = 2;
   condition    = DIA_Xardas_TWO_Rytual_Condition;
   information  = DIA_Xardas_TWO_Rytual_Info;
   permanent	= FALSE;
   description	= "Ju¿ po wszystkim? Po co odprawi³eœ ten rytua³.";
};

FUNC INT DIA_Xardas_TWO_Rytual_Condition()
{
if (Npc_KnowsInfo(hero,DIA_Xardas_TWO))
{
    return TRUE;
};
};
FUNC VOID DIA_Xardas_TWO_Rytual_Info()
{
    AI_Output (other, self ,"DIA_Xardas_TWO_Rytual_15_01"); //Ju¿ po wszystkim? Po co odprawi³eœ ten rytua³.
    AI_Output (self, other ,"DIA_Xardas_TWO_Rytual_03_02"); //To obok twojego przybycia by mi pomóc, by³o kluczowe w tej misji.
    AI_Output (self, other ,"DIA_Xardas_TWO_Rytual_03_03"); //Ju¿ wiem co powinniœmy zrobiæ. Wyczu³em magiczn¹ energiê Orkowych Szamanów.
    AI_Output (self, other ,"DIA_Xardas_TWO_Rytual_03_04"); //To oni utworzyli portal do mojej wie¿y. 
    AI_Output (other, self ,"DIA_Xardas_TWO_Rytual_15_05"); //Tylko gdzie oni s¹?
    AI_Output (self, other ,"DIA_Xardas_TWO_Rytual_03_06"); //Dziêki mojemu rytua³owi wiem, ¿e niedaleko mojej wie¿y. I s¹ wszyscy w jednym miejscu. 
    AI_Output (self, other ,"DIA_Xardas_TWO_Rytual_03_07"); //Ale uwa¿aj zapewne towarzyszy im grupa Orkowych Wojowników.
    AI_Output (other, self ,"DIA_Xardas_TWO_Rytual_15_08"); //Rozprawiê siê z nimi.
    AI_Output (self, other ,"DIA_Xardas_TWO_Rytual_03_09"); //Nie oczekiwa³em innej odpowiedzi. Ruszaj.
    TWO_ORC_SHA();
	B_LogEntry               (TajemniczaWiadomoscOrkow,"Xardas odprawi³ magiczny rytua³ po którym stwierdzi³, ¿e Orkowi szamani, którzy utworzyli jego portal s¹ w pobli¿u jego wie¿y. Wszyscy odprawiaj¹ mod³y blisko siebie. Trzeba ich zg³adziæ tak jak Ich obstawê.");
	AI_StopProcessInfos	(self);
};
...
INSTANCE DIA_Xardas_TWO_Koniec (C_INFO)
{
   npc          = Kdf_404_Xardas;
   nr           = 3;
   condition    = DIA_Xardas_TWO_Koniec_Condition;
   information  = DIA_Xardas_TWO_Koniec_Info;
   permanent	= FALSE;
   description	= "Zabi³em Orkowych Szamanów.";
};

FUNC INT DIA_Xardas_TWO_Koniec_Condition()
{
if (Npc_KnowsInfo(hero,DIA_Xardas_TWO_Rytual))
&& (Npc_IsDead (Shaman_TWO_01))
&& (Npc_IsDead (Shaman_TWO_02))
{
    return TRUE;
};
};
FUNC VOID DIA_Xardas_TWO_Koniec_Info()
{
    AI_Output (other, self ,"DIA_Xardas_TWO_Koniec_15_01"); //Zabi³em Orkowych Szamanów.
    AI_Output (self, other ,"DIA_Xardas_TWO_Koniec_03_02"); //Po ich œmierci pozostali szamani orków raczej nie bêd¹ w stanie powtórzyæ ich wyczynu.
    AI_Output (other, self ,"DIA_Xardas_TWO_Koniec_15_03"); //Dobrze to s³yszeæ.
    AI_Output (self, other ,"DIA_Xardas_TWO_Koniec_03_04"); //Przyznam, ¿e nie spodziewa³em siê, ¿e bêd¹ do tego zdolni.
    AI_Output (other, self ,"DIA_Xardas_TWO_Koniec_15_05"); //Ja te¿. Nie mo¿emy ich lekcewa¿yæ.
    AI_Output (self, other ,"DIA_Xardas_TWO_Koniec_03_06"); //Dobrze siê spisa³eœ. WeŸ ten napój.
	B_GiveInvItems (self,other, ItFo_Potion_Master_01, 1);
    AI_Output (self, other ,"DIA_Xardas_TWO_Koniec_03_07"); //A teraz wracaj do swoich obowi¹zków. A masz ich wiele. Powodzenia.
    B_LogEntry          (TajemniczaWiadomoscOrkow,"Zabi³em Orkowych Szamanów I ich popleczników. Wraz z ich œmierci¹ portal do wie¿y Xardasa przesta³ istnieæ. Uratowa³em Nekromantê a ten odwdziêczy³ mi siê stosown¹ nagrod¹.");
	Log_SetTopicStatus	(TajemniczaWiadomoscOrkow,LOG_SUCCESS);
	B_GiveXP(1000);
};
