...
INSTANCE DIA_Mirzo_Lochy (C_INFO)
{
   ...
   permanent	= FALSE;
   description	= "Jednak nie ca³kiem zgni³eœ w lochu. Widzê, ¿e jeszcze dychasz odrobinê.";
};
...
{
    AI_Output (other, self ,"DIA_Mirzo_Lochy_15_01"); //Jednak nie ca³kiem zgni³eœ w lochu. Widzê, ¿e jeszcze dychasz.
    AI_Output (self, other ,"DIA_Mirzo_Lochy_03_02"); // Ty parchu... Przez ciebie tutaj wyl¹dowa³em i poprzysi¹g³em, ¿e siê za to odegram!
    AI_Output (other, self ,"DIA_Mirzo_Lochy_15_03"); //Delikatnie mówiæ œrednio obecnie widzê taki scenariusz...
    AI_Output (self, other ,"DIA_Mirzo_Lochy_03_04"); //Wszystko siê zmieni. I skoñczysz marnie. Zdech³y, zakrwawiony i olany uryn¹. 
    AI_StopProcessInfos	(self);
};
