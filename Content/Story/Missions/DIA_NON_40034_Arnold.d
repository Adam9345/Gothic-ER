...
FUNC VOID DIA_Arnold_Hello_Info()
{
	...
	AI_Output (self, other,"DIA_Arnold_Hello_03_03"); //Mo¿e ponownie chce zaproponowaæ wspólne polowanie.
	AI_Output (other, self,"DIA_Arnold_Hello_15_04"); //Mo¿liwe.
	AI_Output (self, other,"DIA_Arnold_Hello_03_05"); //Dobra. Pójdê do niego.
...
FUNC VOID DIA_Arnold_AdOC_Info()
{
    ...
    AI_Output (other, self,"DIA_Arnold_AdOC_15_06"); //Jesteœ zdrajc¹ bractwa. Ukrad³eœ cenne prastare tablice i da³eœ nogê.
    ...
    AI_Output (self, other,"DIA_Arnold_AdOC_03_09"); //Nie! Zaczekaj! Pozwól, siê wyt³umaczyæ!
	...
	Info_AddChoice	 (DIA_Arnold_AdOC, "(pozwól mówiæ)" ,DIA_Arnold_AdOC_BACK);
...
func void DIA_Arnold_AdOC_BACK()
{
	...
	AI_Output (self, other,"DIA_Arnold_AdOC_BACK_03_03"); //By³em dobrze zapowiadaj¹cym siê Nowicjuszem w Obozie. Cieszy³em siê u Mistrzów zaufaniem. Wró¿ono mi œwietlist¹ œcie¿kê rozwoju w Bractwie. Móg³bym zostaæ...
	AI_Output (other, self,"DIA_Arnold_AdOC_BACK_15_04"); //Mo¿esz przejœæ do rzeczy? 
	AI_Output (self, other,"DIA_Arnold_AdOC_BACK_03_05"); //Dobrze... Studiowa³em staro¿ytne pisma. Doszed³em w tym do mistrzostwa i to podoba³o siê moim nauczycielom. Wszystko by³o dobrze...
	AI_Output (self, other,"DIA_Arnold_AdOC_BACK_03_06"); //Do tamtego pamiêtnego dnia...
	AI_Output (other, self,"DIA_Arnold_AdOC_BACK_15_07"); //Co siê sta³o?
	AI_Output (self, other,"DIA_Arnold_AdOC_BACK_03_08"); //Baal Cadar wys³a³ mnie w jakiejœ sprawie do Cor Caloma. Ale akurat nikogo nie zasta³em w jego labolatorium.
	...
	AI_Output (other, self,"DIA_Arnold_AdOC_BACK_15_14"); //Czy ja muszê wyduszaæ z Ciebie ka¿de zdanie?
	...
	AI_Output (self, other,"DIA_Arnold_AdOC_BACK_03_16"); //Wtedy postanowi³em udaæ siê z tablicami do Y'Beriona. Jednak w³w tym momencie wróci³ Calom i zrozumia³ co siê sta³o. Rozkaza³ swemu Ochroniarzowi zabiæ mnie.
	AI_Output (self, other,"DIA_Arnold_AdOC_BACK_03_17"); //Musia³em uciekaæ œcigany ludzi Caloma i ukry³em siê tymczasowo w jakisni u Gilberta. A potem przysta³em do myœliwych pod fa³szywym imieniem Arnold.
...
FUNC VOID DIA_Arnold_NoDeath_Info()
{
	...
	AI_Output (self, other,"DIA_Arnold_NoDeath_03_01"); //Dziêkujê. I co teraz?
	AI_Output (other, self,"DIA_Arnold_NoDeath_15_02"); //Cor Calom jest teraz bardzo zajêty. Zosta³em wys³any przez Baala Tondrala. Przeka¿ê mu Twoje œwiadectwo. 
	AI_Output (other, self,"DIA_Arnold_NoDeath_15_03"); //Lepiej jak siê o tym dowie, wtedy bêdziesz bezpieczny.
	AI_Output (self, other,"DIA_Arnold_NoDeath_03_04"); //To wci¹¿ ryzykowne.
	AI_Output (other, self,"DIA_Arnold_NoDeath_15_05"); //Obawiam siê, ¿e nie masz wyjœcia.
	AI_Output (self, other,"DIA_Arnold_NoDeath_03_06"); //Na to wygl¹da.
	AI_Output (other, self,"DIA_Arnold_NoDeath_15_07"); //Trzymaj siê.
	AI_Output (self, other,"DIA_Arnold_NoDeath_03_08"); //Do zobaczenia. Dziêkuje Ci.
...
FUNC VOID DIA_Arnold_AdNC_Info()
{
	...
	AI_Output (other, self,"DIA_Arnold_AdNC_15_02"); //Wszystko zrozumia³ i przyj¹³. Jesteœ teraz bezpieczny.
	...
	AI_Output (self, other,"DIA_Arnold_AdNC_03_05"); //M¹dry to cz³owiek. S³uszna decyzja. Bêdê mia³ na nie oko przez ca³y czas.
	AI_Output (self, other,"DIA_Arnold_AdNC_03_06"); //Jeszcze raz dziêki.
	AI_Output (self, other,"DIA_Arnold_AdNC_03_07"); //WeŸ tê skórê, chocia¿ tyle mogê dla Ciebie zrobiæ. Zapewne warta jest niez³¹ sumkê.
...
FUNC VOID DIA_Arnold_HI_AR_Info()
{
    ...
    AI_Output (self, other ,"DIA_Arnold_HI_AR_03_04"); //Nieszczególnie. Ale lubiê ten fach i jest on doœæ dochodowy. Uczy jak przetrwaæ i wykorzystywaæ naturalne zasoby.
    AI_Output (other, self ,"DIA_Arnold_HI_AR_15_05"); //Dlaczego zrzucono ciê do bariery?
    AI_Output (self, other ,"DIA_Arnold_HI_AR_03_06"); //Pewien facet oszukiwa³ w koœci. A ja jak narwany m³ody byk postanowi³em daæ mu nauczkê.
    AI_Output (self, other ,"DIA_Arnold_HI_AR_03_07"); //Nagle rozbi³ butelkê o kant sto³u I próbowa³ mnie ni¹ zabiæ. Chyba Beliar we mnie wst¹pi³….
    AI_Output (self, other ,"DIA_Arnold_HI_AR_03_08"); //Wyrwa³em mu j¹ i przeci¹³empodci¹³em mu têtnicê.
    AI_Output (self, other ,"DIA_Arnold_HI_AR_03_09"); //Gor¹cy m³ody ³eb i chwila upojenia alkoholowego kosztowa³a mnie wolnoœæ.
};
var int Go_To_Bears;
var int IKnowArnold;
//========================================
...
FUNC VOID DIA_Arnold_NP_GoToMe_Info()
{
    ...
    AI_Output (self, other ,"DIA_Arnold_NP_GoToMe_03_05"); //Nie. Mam do ciebie pewien intres. Mo¿esz mi pomóc i dobrze te¿ zarobiæ.
    AI_Output (other, self ,"DIA_Arnold_NP_GoToMe_15_06"); //A có¿ to zainteres?
    ...
    AI_Output (self, other ,"DIA_Arnold_NP_GoToMe_03_09"); //Na niedŸwiedzie. Tylko utalentowani myœliwi siê tego podejmuj¹. Wierzê w siebie. A i ty jesteœ bystry.
    AI_Output (self, other ,"DIA_Arnold_NP_GoToMe_03_10"); //We dwóch mo¿emy zapolowaæ na wielkiego niedŸwiedzia, mieæ niez³¹ frajdê i bardzo dobrze zarobiæ na trofeach.
    ...
    AI_Output (self, other ,"DIA_Arnold_NP_GoToMe_03_12"); //Wiêcej wiary! Jesteœmy twardymi zawodnikami, a nie ¿ó³todziobami.
    AI_Output (self, other ,"DIA_Arnold_NP_GoToMe_03_13"); //To jak bêdzie... Idziesz ze mn¹, czy wymiêkszasz?
	IKnowArnold = TRUE;
...
FUNC VOID DIA_Arnold_NOILIKEBEARS()
{
    ...
    AI_Output (self, other ,"DIA_Arnold_NOILIKEBEARS_03_02"); //Có¿, zachowawczo i tchórzliwie. Myœla³em, ¿e odwa¿ny z ciebie cz³owiek. Zawiod³em siê na tobie.
    AI_Output (other, self ,"DIA_Arnold_NOILIKEBEARS_15_03"); //Wolê ciê zawieœæ ni¿ zgin¹æ bêd¹c rozszarpany przez potêzne w³ochate bydle.
    AI_Output (self, other ,"DIA_Arnold_NOILIKEBEARS_03_04"); //Ee... Bójdupa... Có¿ zapoluje z kimœ innym. Bywaj panie odwa¿ny inaczej...
...
FUNC VOID DIA_Arnold_KILLBEARS()
{
    ...
    AI_Output (self, other ,"DIA_Arnold_KILLBEARS_03_05"); //Wiem mniej wiecej gdzie ten niedŸwiedŸ ¿eruje.
    AI_Output (self, other ,"DIA_Arnold_KILLBEARS_03_06"); //To bêdzie trudne, ale takie wyzwania w myœlistwie do czysta andrenalina.
    AI_Output (self, other ,"DIA_Arnold_KILLBEARS_03_07"); //No i pieni¹dze za trofea te¿ zachêcaj¹.
...
FUNC VOID DIA_Arnold_Where_You_Bear_Info()
{
    ...
    AI_Output (self, other ,"DIA_Arnold_Where_You_Bear_03_02"); //Dobra jeœli naprawdê jesteœ na to gotowy to mo¿emy iœæ.
    AI_Output (self, other ,"DIA_Arnold_Where_You_Bear_03_03"); //I pamiêtaj.... Na pocz¹tku zrobimy rekonesans.
    AI_Output (self, other ,"DIA_Arnold_Where_You_Bear_03_04"); //Dopiero wtedy uderzymy na zwierza. Nie mo¿emy dzia³aæ bezmyœlnie.
    AI_Output (other, self ,"DIA_Arnold_Where_You_Bear_15_05"); //Zgoda. Frontalny atak to œwietny sposób na szybk¹ œmieræ.
    AI_Output (self, other ,"DIA_Arnold_Where_You_Bear_03_06"); //A zatem w drogê.
...
FUNC VOID DIA_Arnold_I_SEE_BEAR_Info()
{
    ...
    AI_Output (other, self ,"DIA_Arnold_I_SEE_BEAR_15_02"); //Dwa niedŸwiedzie naraz. No nieŸle.
...
FUNC VOID DIA_Arnold_Bears_Are_Die_Info()
{
    ...
    AI_Output (self, other ,"DIA_Arnold_Bears_Are_Die_03_04"); //Prosty podzia³. Po jednej skóze na ³eb. 
    AI_Output (self, other ,"DIA_Arnold_Bears_Are_Die_03_05"); //Miêso i sad³o mo¿esz zachowaæ.
    AI_Output (other, self ,"DIA_Arnold_Bears_Are_Die_15_06"); //WeŸ tê skórê.
    AI_Output (self, other ,"DIA_Arnold_Bears_Are_Die_03_07"); //Dziêki. TerazTo wartoœciowy kawa³ skóry.
    AI_Output (other, self ,"DIA_Arnold_Bears_Are_Die_15_08"); //Mia³eœ racjê, takie wyzwania to czysta andrenalina.
    AI_Output (self, other ,"DIA_Arnold_Bears_Are_Die_03_09"); //Pewnie nie lubisz rutyny... Myœliwy zwykle d³ugo pod¹¿a za zwierzyn¹, ale Kolonia to ograniczony teren.
    AI_Output (self, other ,"DIA_Arnold_Bears_Are_Die_03_10"); //Wiêc czasami wkrada siê nuda. Pewnie chcesz ruszaæ dalej. Nie bêdê ciê d³u¿ej zatrzymywa³. A koñcz¹c sprawê...
	AI_Output (self, other ,"DIA_Arnold_Bears_Are_Die_03_11"); //Handlarz Gavilan w Kotle nieŸle ci zap³aci za t¹ skórê. Sam te¿ muszê do niego zagl¹dn¹æ.
