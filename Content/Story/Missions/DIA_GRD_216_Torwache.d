...
INSTANCE DIA_Torwache2_PP_ARMOR (C_INFO)
{
   npc          = Grd_216_Torwache;
   nr           = 1;
   condition    = DIA_Torwache2_PP_ARMOR_Condition;
   information  = DIA_Torwache2_PP_ARMOR_Info;
   permanent	= FALSE;
   Important    = TRUE;
};

FUNC INT DIA_Torwache2_PP_ARMOR_Condition()
{
...
FUNC VOID DIA_Torwache2_PP_ARMOR_Info()
{
    AI_Output (self, other ,"DIA_Torwache2_PP_ARMOR_03_01"); //Hej ty! 
    AI_Output (other, self ,"DIA_Torwache2_PP_ARMOR_15_02"); //O co chodzi?
    AI_Output (self, other ,"DIA_Torwache2_PP_ARMOR_03_03"); //Myœlisz ¿e wpuszczê ciê do obozu w takim pancerzu?
    AI_Output (self, other ,"DIA_Torwache2_PP_ARMOR_03_04"); //Od razu widaæ ¿e zdj¹³eœ go z jakiegoœ trupa!
    AI_Output (self, other ,"DIA_Torwache2_PP_ARMOR_03_05"); //Teraz podzielisz jego los!
	AI_StopProcessInfos	(self);
