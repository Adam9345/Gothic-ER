...
INSTANCE DIA_Fisk_PNA_Skory (C_INFO)
{
   ...
   permanent	= FALSE;
   description	= "Mam skóry aligatorów. Chodzi mi o zlecenie dla magnatów.";
};
...
{
    AI_Output (other, self ,"DIA_Fisk_PNA_Skory_15_01"); //Mam skóry aligatorów. Chodzi mi o zlecenie dla magnatów.
    AI_Output (self, other ,"DIA_Fisk_PNA_Skory_03_02"); //Aaaa... Tak, jasne. Wiem o co chodzi. Mam ju¿ listê tego co wykonaæ z tych skór.
    AI_Output (other, self ,"DIA_Fisk_PNA_Skory_15_03"); //Oto skóry aligatorów.
	B_GiveInvItems (other,self, ItAt_Alligator_Skin, 5);
	Npc_RemoveInvItems(Stt_311_Fisk, ItAt_Alligator_Skin, 5);
    AI_Output (self, other ,"DIA_Fisk_PNA_Skory_03_04"); //Dziêki. Dostanê niez³¹ sumkê za tê robotê.
    AI_Output (other, self ,"DIA_Fisk_PNA_Skory_15_05"); //Tak jak my. W koñcu to myœliwi i ja ubrudziliœmy sobie miecze w krwi.
	AI_Output (self, other ,"DIA_Fisk_PNA_Skory_03_06"); //To umyjcie je w rzece hehe. Ka¿dy dostanie tyle, ¿e bêdzie zadowolony. JA ci to mówiê.
    AI_Output (other, self ,"DIA_Fisk_PNA_Skory_15_07"); //Obyœ mia³ racjê.
