...
FUNC VOID DIA_Viran_DawajZielezAGoldy_Info()
{
    ...
    if (Viran_Bloodflies == LOG_SUCCESS)
    {
        ...
        {
            AI_Output (other, self ,"DIA_Viran_DawajZielezAGoldy_15_03"); //Tak, oto one! Ale zaraz... mówi³eœ ¿e nie masz go przy sobie! A zreszt¹...
    ...
    else
    {
        ...
        {
            AI_Output (other, self ,"DIA_Viran_DawajZielezAGoldy_15_07"); //Jasne. Ale zaraz... mówi³eœ ¿e nie masz go przy sobie! A zreszt¹...
...
INSTANCE DIA_Viran_Cronnos_Plants (C_INFO)
{
   npc          = Nov_1302_Viran;
   nr           = 1;
   condition    = DIA_Viran_Cronnos_Plants_Condition;
   information  = DIA_Viran_Cronnos_Plants_Info;
   permanent	= FALSE;
   description	= "Cronos chcê swoje roœliny.";
};

FUNC INT DIA_Viran_Cronnos_Plants_Condition()
{
    if (Npc_KnowsInfo (hero, DIA_Cronos_Richard_Rio))
...
FUNC VOID DIA_Viran_Cronnos_Plants_Info()
{
    AI_Output (other, self ,"DIA_Viran_Cronnos_Plants_15_01"); //Cronos chcê swoje roœliny.
    AI_Output (self, other ,"DIA_Viran_Cronnos_Plants_03_02"); //Aaaaa... Prawie ju¿ o tym zapomnia³em.
    AI_Output (self, other ,"DIA_Viran_Cronnos_Plants_03_03"); //Myœla³em ju¿, ¿e nikt ju¿ nie zg³osi siê w tej sprawie. 
    AI_Output (other, self ,"DIA_Viran_Cronnos_Plants_15_04"); //Mam nadzieje, ¿e nadal je masz.
    AI_Output (self, other ,"DIA_Viran_Cronnos_Plants_03_05"); //Tak, w koñcu mi mo¿na zaufaæ. 
	CreateInvItems	(self, ItMi_Cronos_Plants, 1);
	B_GiveInvItems (self,other, ItMi_Cronos_Plants, 1);
    AI_Output (self, other ,"DIA_Viran_Cronnos_Plants_03_06"); //Masz.
    AI_Output (other, self ,"DIA_Viran_Cronnos_Plants_15_07"); //Dziêki.
    AI_Output (self, other ,"DIA_Viran_Cronnos_Plants_03_08"); //A zap³ata?
    AI_Output (other, self ,"DIA_Viran_Cronnos_Plants_15_09"); //Skoro Cronos nic o tym nie mówi³, znaczy zosta³eœ ju¿ op³acony!
    AI_Output (self, other ,"DIA_Viran_Cronnos_Plants_03_10"); //No tak, tak... Grzech by³o nie spróbowaæ.
    AI_Output (other, self ,"DIA_Viran_Cronnos_Plants_15_11"); //Wracaj do swoich wodorostów. A ja pomówiê z Cronosem!
