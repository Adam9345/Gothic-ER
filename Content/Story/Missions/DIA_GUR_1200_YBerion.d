...
FUNC VOID DIA_Yberion_MessengerStartInfo_Info()
{
    ...
    AI_Output (self, other ,"DIA_Yberion_MessengerStartInfo_03_13"); //Guru spisa³ listê przedmiotów ze sto³u ofiarnego. Bêd¹ one potrzebne do odprawienia rytua³u przywo³ania magicznego Pos³añca. Czêœæ z nich znajdziesz u nowicjusza Fortuno.
	...
	B_LogEntry(CH2_MessengerRecall,"Y'Berion wyjaœni³ mi, ¿e jeden z Guru doœwiadczy³ wizji, w której objawi³ mu siê rytua³ przywo³ania pos³añca Œni¹cego. Ta magiczna istota mo¿e daæ Bractwu odpowiedzi na pytania zwi¹zane z wielkim przywo³aniem Œni¹cego. Da³ mi listê rzeczy, które muszê zdobyæ i zanieœæ do Kaloma. Czêœæ z nich znajdê u nowicjusza Fortuno.");
	FortunoRespItems();
...
FUNC VOID DIA_Yberion_KASADZIADU_Info()
{
    ...
    AI_Output (other, self ,"DIA_Yberion_KASADZIADU_15_02"); //Obieca³eœ 1000 bry³ek rudy  Bandytom.
    AI_Output (self, other ,"DIA_Yberion_KASADZIADU_03_03"); //Ach, tak. Zapomnia³em. Proszê bardzo.
...
INSTANCE DIA_Yberion_HOW_YOU_LEADER (C_INFO)
{
   ...
   permanent	= FALSE;
   description	= "Jak odkry³eœ, ¿e chcesz byæ duchowym liderem?";
};
...
{
    AI_Output (other, self ,"DIA_Yberion_HOW_YOU_LEADER_15_01"); //Jak odkry³eœ, ¿e chcesz byæ duchowym liderem?
    AI_Output (self, other ,"DIA_Yberion_HOW_YOU_LEADER_03_02"); //To samo przysz³o do mnie. Œni¹cy powo³a³ mnie bym by³ duchowym drogowskazem.
    AI_Output (self, other ,"DIA_Yberion_HOW_YOU_LEADER_03_03"); //Wtedy przed laty w Starym Obozie wielu by³o niezadowolonych z codziennej egzystencji. Ludzie przestali mieæ cel, tracili wiarê.
    AI_Output (self, other ,"DIA_Yberion_HOW_YOU_LEADER_03_04"); //Lecz ci, którzy poczuli moc Œni¹cego wsparli moj¹ inicjatywê. Wtedy poczu³em jeszcze wiêksz¹ si³ê.
    AI_Output (other, self ,"DIA_Yberion_HOW_YOU_LEADER_15_05"); //Nie czujesz siê tym przyt³oczony?
    AI_Output (self, other ,"DIA_Yberion_HOW_YOU_LEADER_03_06"); //A czym¿e to?
    AI_Output (other, self ,"DIA_Yberion_HOW_YOU_LEADER_15_07"); //Jesteœ nie tylko przywódc¹ obozu ale te¿ duchowym przywódc¹. To tworzy presjê I absorbuje.
    AI_Output (self, other ,"DIA_Yberion_HOW_YOU_LEADER_03_08"); //Haaa... Od Œni¹cego sp³ywa na mnie dar energii by zarz¹dzaæ obozem I ¿yciem duchowym jego mieszkañców.
    AI_Output (self, other ,"DIA_Yberion_HOW_YOU_LEADER_03_09"); //Muszê spajaæ t¹ wspólnotê. I póki, ¿yje tak w³aœnie bêdzie!
    AI_Output (self, other ,"DIA_Yberion_HOW_YOU_LEADER_03_10"); //Nie mogê zawieœæ ¿adnej z kast, które mam pod duchowym zwierzchnictwem. 
    AI_Output (other, self ,"DIA_Yberion_HOW_YOU_LEADER_15_11"); //Rozumiem. To dosyæ ciekawe.
};
