...
FUNC VOID DIA_Pirat2_AngusKurwoAnie_Info()
{
    ...
    AI_Output (self, other ,"DIA_Pirat2_AngusKurwoAnie_03_02"); //Nazywam siê Steve. Chyba nie muszê mówiæ ¿e jestem piratem...
...
//-----------------> Eq
//========================================
func void SteveEq_Respawn()
{


Wld_InsertItem (ITMI_PACZKAMIECZE1,"FP_ITEM_STEVEPACK_01"); 
Wld_InsertItem (ITMI_PACZKAMIECZE1,"FP_ITEM_STEVEPACK_02"); 
Wld_InsertItem (ITMI_PACZKAMIECZE1,"FP_ITEM_STEVEPACK_03"); 
Wld_InsertItem (ITMI_PACZKAMIECZE1,"FP_ITEM_STEVEPACK_04"); 
Wld_InsertItem (ITMI_PACZKAMIECZE1,"FP_ITEM_STEVEPACK_05"); 
Wld_InsertItem (ITMI_PACZKAMIECZE1,"FP_ITEM_STEVEPACK_06"); 



Wld_InsertItem (ItMi_Steve_Nugget,"FP_ITEM_STEVENUGG_01"); 
Wld_InsertItem (ItMi_Steve_Nugget,"FP_ITEM_STEVENUGG_02"); 
Wld_InsertItem (ItMi_Steve_Nugget,"FP_ITEM_STEVENUGG_03"); 
...
FUNC VOID DIA_Pirat2_Eq_Info()
{
    ...
    AI_Output (self, other ,"DIA_Pirat2_Eq_03_04"); //IdŸ pod tamte resztki statku. ObejdŸ te¿ ca³y brzeg.
    ...
    B_LogEntry               (CH4_StevesEquipment,"Steve kaza³ mi przynieœæ ekwipunek, który znajdê wokó³ wraku statku i le¿y na brzegu morza. Mam szukaæ paczek z broni¹ i ciê¿kich sakiewek z rud¹.");
};
...
FUNC INT DIA_Pirat2_GiveEqZgubione_Condition()
{
    ...
    && (Npc_HasItems (other, ItMi_Steve_Nugget) >=3)
    {
    return TRUE;
    };
};
...
instance dia_pirat2_pickpocket(c_info) {
    npc = non_5025_pirat2;
    nr = 900;
    condition = dia_pirat2_pickpocket_condition;
    information = dia_pirat2_pickpocket_info;
    permanent = 1;
    description = pickpocket_final;
};

func int dia_pirat2_pickpocket_condition() {
	e_beklauen(baseThfChanceSTT, 45);
};

func void dia_pirat2_pickpocket_info() {
	b_steal_message();
	info_clearchoices(dia_pirat2_pickpocket);
	info_addchoice(dia_pirat2_pickpocket, dialog_back, dia_pirat2_pickpocket_back);
	info_addchoice(dia_pirat2_pickpocket, dialog_pickpocket, dia_pirat2_pickpocket_doit);
};

func void dia_pirat2_pickpocket_doit() {
    d_beklauen();
    info_clearchoices(dia_pirat2_pickpocket);
};

func void dia_pirat2_pickpocket_back() {
    info_clearchoices(dia_pirat2_pickpocket);
};