...
{
	if (( Npc_KnowsInfo (hero,DIA_Scatty_JoinOC) && Npc_KnowsInfo(hero,Info_Kharim_What) && (Kharim_Charged != TRUE) && (Kapitel <= 1) ) && (Kharim_Charged != TRUE)) || (MIS_HanisAsTeacher == LOG_RUNNING)// Kapitelfix ***Björn***
	{
		return 1;
	};
};
