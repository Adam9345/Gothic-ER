//poprawione i sprawdzone -  /g1210/Reflide
...
INSTANCE DIA_Butch_SWINEY (C_INFO)
{
   npc          = Org_851_Butch;
   nr           = 2;
   condition    = DIA_Butch_SWINEY_Condition;
   information  = DIA_Butch_SWINEY_Info;
   permanent	= FALSE;
  description = "Hej, podobno trzymasz z goœciem o ksywce Grabarz.";
};

FUNC INT DIA_Butch_SWINEY_Condition()
{
    if  (Npc_KnowsInfo(hero,Info_Casper_Schuerfer))
    {
    return TRUE;
    };
};
...
FUNC VOID DIA_Butch_SWINEY_Info()
{
    AI_Output (other, self ,"DIA_Butch_SWINEY_15_01"); //Hej, podobno trzymasz z goœciem o ksywce Grabarz.
    AI_Output (self ,other ,"DIA_Butch_SWINEY_03_02"); //Nic ci to tego palancie. Nie ruszaj na darmo t¹ brzydk¹ gêb¹ i zejdŸ mi z oczu.
    AI_Output (other, self ,"DIA_Butch_SWINEY_15_03"); //Ale...
    AI_Output (self ,other ,"DIA_Butch_SWINEY_03_04"); //Won!
    AI_StopProcessInfos	(self);
...
INSTANCE DIA_Butch_ATAK (C_INFO)
{
   npc          = Org_851_Butch;
   nr           = 2;
   condition    = DIA_Butch_ATAK_Condition;
   information  = DIA_Butch_ATAK_Info;
   permanent	= FALSE;
   Important    = TRUE;
};

FUNC INT DIA_Butch_ATAK_Condition()
{
    if (Npc_KnowsInfo(hero,DIA_CIPHER_ATAK_LAS))
    {
    return TRUE;
    };
};
...
FUNC VOID DIA_Butch_ATAK_Info()
{
    AI_Output (self ,other ,"DIA_Butch_ATAK_03_01"); //Ciszej durnie, chyba nadchodz¹.
    Npc_ExchangeRoutine (GRD_40050_Straznik,"konwoj2");
    Npc_ExchangeRoutine (GRD_40049_Straznik,"konwoj2");
    Npc_ExchangeRoutine (GRD_40048_Straznik,"konwoj2");
    Npc_ExchangeRoutine (VLK_40044_Inzynier,"konwoj2");
