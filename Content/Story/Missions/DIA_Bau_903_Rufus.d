...
FUNC VOID DIA_Rufus_Plaga_Info()
{
    ...
    AI_Output (self, other ,"DIA_Rufus_Plaga_03_02"); //I co z tego? Jeœli mam wybieraæ miêdzy prac¹ na polu ry¿owym a u¿eraniu siê ze szczurami to wybieram pole ry¿u!
    AI_Output (other, self ,"DIA_Rufus_Plaga_15_03"); // Na pewno nie dasz siê przekonaæ? Ry¿owy Ksi¹¿e zap³aci ci za pomoc.
    AI_Output (self, other ,"DIA_Rufus_Plaga_03_04"); //Nie ufam tej ¿mij. Niech sam sobie lata za szczurzyskami. 
    AI_Output (other, self ,"DIA_Rufus_Plaga_15_05"); //W takim razie pogadam z kimœ innym.
	B_LogEntry               (Plaga,"Rufus woli swoj¹ obecn¹ pracê na polu ry¿u. Nie bêdzie pilnowaæ magazynu Ry¿owego Ksiêcia.");
};
...
{
    AI_Output (self, other ,"DIA_Rufus_Poszkodowani_03_02"); //Witaj nowy. Mo¿e œwie¿a krew pomo¿e...
    AI_Output (other, self ,"DIA_Rufus_Poszkodowani_15_05"); //Jaka œwie¿a krew? Do czego zmierzasz?
    AI_Output (self, other ,"DIA_Rufus_Poszkodowani_03_03"); //Mo¿e ty znajdziesz sposób na rozwik³anie naszej sprawy.
    AI_Output (self, other ,"DIA_Rufus_Poszkodowani_03_04"); //Nie doœæ, ¿e jesteœmy uciskani przez Lewusa i Ry¿owego Ksiêcia to mamy jeszcze jeden problem.
    AI_Output (other, self ,"DIA_Rufus_Poszkodowani_15_05"); //Jaki?
    AI_Output (self, other ,"DIA_Rufus_Poszkodowani_03_06"); //Ktoœ systematycznie nas okrada. Znika ruda, jedzenie i wszystko co ma jak¹kolwiek wartoœæ.
    AI_Output (other, self ,"DIA_Rufus_Poszkodowani_15_07"); //Co z wasz¹ czujnoœci¹? Dajcie siê tak ³atwo podejœæ.
    AI_Output (self, other ,"DIA_Rufus_Poszkodowani_03_08"); //Cz³owieku mamy mnóstwo pracy na g³owie. Ma³o czasu dla siebie. Zwykle praca i sen. Wiêc to nie nasza wina, ¿e jesteœmy ³atwym celem.
    AI_Output (other, self ,"DIA_Rufus_Poszkodowani_15_09"); //Co mam zrobiæ z waszym problemem?
    AI_Output (self, other ,"DIA_Rufus_Poszkodowani_03_10"); //Popytaj ludzi na polach ry¿owych o kradzie¿e i ogó³em o ostanie wydarzenia.
    AI_Output (self, other ,"DIA_Rufus_Poszkodowani_03_11"); //Na pewno dowiesz siê czegoœ co bêdzie przydatne.
    AI_Output (other, self ,"DIA_Rufus_Poszkodowani_15_12"); //Dobrze ale nie za darmo.
    AI_Output (self, other ,"DIA_Rufus_Poszkodowani_03_13"); //Dostaniesz stosown¹ zap³atê.
    AI_Output (other, self ,"DIA_Rufus_Poszkodowani_15_14"); //No ja myœlê. Na razie.
	Log_CreateTopic		(PoszkodowaniZbieracze,	LOG_MISSION);
	Log_SetTopicStatus	(PoszkodowaniZbieracze, LOG_RUNNING);
	B_LogEntry          (PoszkodowaniZbieracze,"Rufus powiedzia³ mi o kradzie¿ach, których ofiar¹ padaj¹ zbieracze. Mogê odp³atnie mu pomóc. Poleci³ mi bym popyta³ zbieraczy o t¹ sprawê. Zacznê od Horacego.");
...
INSTANCE DIA_Rufus_PZ_ENDE (C_INFO)
{
   ...
   permanent	= FALSE;
   description	= "Nie bêdziecie ju¿ okradani.";
};
...
{
    AI_Output (other, self ,"DIA_Rufus_PZ_ENDE_15_01"); //Nie bêdziecie ju¿ okradani.
    AI_Output (self, other ,"DIA_Rufus_PZ_ENDE_03_02"); //Rozwi¹za³eœ t¹ sprawê?
    AI_Output (other, self ,"DIA_Rufus_PZ_ENDE_15_03"); //Foster trzyma³ z rozbójnikami. Potem chcia³ z tym skoñczyæ ale oni go szanta¿owali.
    ...
    AI_Output (self, other ,"DIA_Rufus_PZ_ENDE_03_07"); //A ty zas³u¿u³eœ na nagrodê. W koñcu ci zbójce mogli dalej próbowaæ nas okradaæ.
    AI_Output (self, other ,"DIA_Rufus_PZ_ENDE_03_08"); //WeŸ w nagrodê te szkatu³ki. Ka¿dy z nas przygotowa³ coœ dla osoby która rozwi¹¿e tê sprawê.
    AI_Output (other, self ,"DIA_Rufus_PZ_ENDE_15_09"); //Dziêki.
	B_LogEntry           (PoszkodowaniZbieracze,"Powiedzia³em Rufusowi o Fosterze i rozbójnikach. Zbieracz da³ mi stosown¹ zap³atê i by³ wdziêczny za okazan¹ pomoc.");
...
INSTANCE DIA_Rufus_PZEEEND (C_INFO)
{
   ...
   permanent	= FALSE;
   description	= "Rozwi¹za³em sprawê kradzie¿y.";
};
...
{
    AI_Output (other, self ,"DIA_Rufus_PZEEEND_15_01"); //Rozwi¹za³em sprawê kradzie¿y.
    AI_Output (self, other ,"DIA_Rufus_PZEEEND_03_02"); //Niby jak?
    AI_Output (other, self ,"DIA_Rufus_PZEEEND_15_03"); //Odkry³em, ¿e okradali was rozbójnicy. Razem z Gornem pozbyliœmy siê ich na dobre.
    AI_Output (self, other ,"DIA_Rufus_PZEEEND_03_04"); //Gorn to równy goœæ wiêc nie bra³by udzia³ w jakimœ szwindlu. 
    AI_Output (self, other ,"DIA_Rufus_PZEEEND_03_05"); //Skoro pozbyliœcie siê naszego problemu to powinieneœ zostaæ wynagrodzony. 
    AI_Output (self, other ,"DIA_Rufus_PZEEEND_03_06"); //WeŸ w nagrodê te szkatu³ki. Ka¿dy z nas przygotowa³ coœ dla osoby która rozwi¹¿e tê sprawê.
    B_GiveInvItems (self,other, ItMi_JeweleryChest_01, 8);    
	AI_Output (other, self ,"DIA_Rufus_PZEEEND_15_07"); //Dziêki.
    AI_Output (self, other ,"DIA_Rufus_PZEEEND_03_08"); //Swoj¹ drog¹ to dziwne...Nie widzia³em jakiœ nowych ludzi, którzy krêcili sie wokó³ zbieraczy...
    AI_Output (other, self ,"DIA_Rufus_PZEEEND_15_09"); //Mo¿e sami siê za nich przebrali albo za Szkodników... W ka¿dym razie ich z³odziejski proceder w³aœnie siê skoñczy³.
    AI_Output (self, other ,"DIA_Rufus_PZEEEND_03_10"); //I bardzo dobrze. Jeszcze raz dziêki.
	B_LogEntry           (PoszkodowaniZbieracze,"Pogada³em z Rufusem. Da³ mi nagrodê chodŸ wyda³o mu siê dziwne, ¿e zbóje bezpoœrednio okradali Kopaczy. Wa¿ne jednak, ¿e uzna³, ¿e ostatecznie to mo¿liwe i przyzna³ mi nagrodê. ");
