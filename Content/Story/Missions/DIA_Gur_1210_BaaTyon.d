...
INSTANCE DIA_BaalTyon_HI_HERO (C_INFO)
{
   npc          = Gur_1210_BaalTyon;
   nr           = 1;
   condition    = DIA_BaalTyon_HI_HERO_Condition;
   information  = DIA_BaalTyon_HI_HERO_Info;
   permanent	= FALSE;
   important    = TRUE;
};

FUNC INT DIA_BaalTyon_HI_HERO_Condition()
{
...
FUNC VOID DIA_BaalTyon_HI_HERO_Info()
{
    AI_Output (self, other ,"DIA_BaalTyon_HI_HERO_03_01"); //Dokona³eœ s³usznego wyboru staj¹c siê cz³onkiem naszem duchowej wspólnoty.
    AI_Output (self, other ,"DIA_BaalTyon_HI_HERO_03_02"); //To powinno byæ dla ciebie zaszczytem. Mam nadzieje, ¿e pewnego dnia i zaszczytem dla wszystkich cz³onków Bractwa bêdzie to, ¿e jesteœ wœród nas.
    AI_Output (other, self ,"DIA_BaalTyon_HI_HERO_15_03"); //Czeka mnie daleka droga.
    AI_Output (self, other ,"DIA_BaalTyon_HI_HERO_03_04"); //Jeœli Œni¹cy bêdzie ci drogowskazem to dotrzesz tam gdzie chcesz. Ale twoja wiara musi byæ mocna.
    AI_Output (other, self ,"DIA_BaalTyon_HI_HERO_15_05"); //Zgadza siê.
    AI_Output (self, other ,"DIA_BaalTyon_HI_HERO_03_06"); //Niech nadejdzie dzieñ chwa³y Œni¹cego I wszystkich jego stronników!
    AI_StopProcessInfos	(self);
};
