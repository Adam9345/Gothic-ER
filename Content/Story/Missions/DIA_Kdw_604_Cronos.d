...
INSTANCE DIA_Cronos_Liliput (C_INFO)
{
   ...
   permanent	= FALSE;
   description	= "Witaj Magu! Mam do ciebie pewn¹ sprawê.";
};
...
{
    AI_Output (other, self ,"DIA_Cronos_Liliput_15_01"); //Witaj Magu! Mam do ciebie pewn¹ sprawê.
    AI_Output (self, other ,"DIA_Cronos_Liliput_03_02"); //O co chodzi?
	AI_Output (other, self ,"DIA_Cronos_Liliput_15_03"); //Pewien cz³owiek pad³ ofiar¹ kl¹twy ze strony przeklêtego amuletu Orków.
    AI_Output (self, other ,"DIA_Cronos_Liliput_03_04"); //Co konkretnie mu siê sta³o?
	AI_Output (other, self ,"DIA_Cronos_Liliput_15_05"); //Có¿... Sta³ siê zwyczajnym kar³em.
    AI_Output (self, other ,"DIA_Cronos_Liliput_03_06"); //W artefaktach Orków czêsto jest zawarta jakaœ z³a moc, któregoœ z ich bóstw. Tak by³o i tym razem.
	AI_Output (self, other ,"DIA_Cronos_Liliput_03_07"); //Ale nic dziwnego, magia orków jest niezwykle silna, czêsto potê¿ni Magowie ludzi nie s¹ w stanie jej sprostaæ. 
    AI_Output (self, other ,"DIA_Cronos_Liliput_03_08"); //Trzeba te¿ przyznaæ, ¿e kl¹twa jest doœæ pomys³owa.  Mogê jednak spróbowaæ siê z ni¹ zmierzyæ. Oczywiœcie to kosztuje...
	AI_Output (other, self ,"DIA_Cronos_Liliput_15_09"); //Ile?
    AI_Output (self, other ,"DIA_Cronos_Liliput_03_10"); //200 bry³ek rudy.
	B_LogEntry          (Liliput,"Cronos zgodzi³ siê mi pomóc ale ¿¹da 200 bry³ek rudy i tego talizmanu. Muszê mu to daæ jeœli chcê popchn¹æ sprawê dalej.");
...
INSTANCE DIA_Cronos_Liliput_Ruda (C_INFO)
{
   ...
   permanent	= FALSE;
   description	= "Proszê. Oto 200 bry³ek rudy.";
};
...
{
    AI_Output (other, self ,"DIA_Cronos_Liliput_Ruda_15_01"); //Proszê. Oto 200 bry³ek rudy.
    AI_Output (self, other ,"DIA_Cronos_Liliput_Ruda_03_02"); //Teraz bêdê potrzebowa³ kilku rzeczy. Pierwsz¹ z nich ju¿ mam to flakon ze œwiêcon¹ wod¹ Adanosa.
	AI_Output (self, other ,"DIA_Cronos_Liliput_Ruda_03_03"); //Potrzebuje jeszcze sztabki z³ota, plastra miodu i pukla w³osów tego nieszczêœnika, ob³o¿onego kl¹tw¹. 
    AI_Output (self, other ,"DIA_Cronos_Liliput_Ruda_03_04"); //I mo¿emy rozpocz¹æ rytua³ zdjêcia kl¹twy. A i daj mi ten medalion, muszê zbadaæ z³¹ moc, która w nim drzemie.
	AI_Output (other, self ,"DIA_Cronos_Liliput_Ruda_15_05"); //Oto i on, a teraz ruszam po potrzebne rzeczy. A i jeszcze jedno gdzie znajdê plaster miodu?
	...
	B_LogEntry          (Liliput,"Zap³aci³em Cronosowi. Mówi, ¿e do rytua³u potrzebuje flakon z wod¹ œwiêcon¹ Adanosa, który ju¿ ma a tak¿e kilka sk³adników, które muszê zdobyæ. To plaster miodu, sztabka z³ota i pukiel w³osów ob³o¿onego kl¹tw¹ Stuarta.");
...
FUNC VOID DIA_Cronos_Liliput_Ruda1_Info()
{
    ...
    AI_Output (self, other ,"DIA_Cronos_Liliput_Ruda1_03_02"); //Zatem mo¿emy zaczynaæ.
	AI_Output (self, other ,"DIA_Cronos_Liliput_Ruda1_03_03"); //O Adanosie! Obda¿ nas sw¹ ³ask¹!
    AI_Output (self, other ,"DIA_Cronos_Liliput_Ruda1_03_04"); //Spraw by to zaklêcie opuœci³o duszê i cia³o niewinnego!
...
FUNC VOID DIA_Cronos_Liliput_Ritual_Info()
{
    ...
    AI_Output (self, other ,"DIA_Cronos_Liliput_Ritual_03_02"); //Mam nadziejê ¿e siê uda³o.
	AI_Output (other, self ,"DIA_Cronos_Liliput_Ritual_15_03"); //Oby... Dziêki za pomoc!
    AI_Output (self, other ,"DIA_Cronos_Liliput_Ritual_03_04"); //Niech Adanos ma cie zawsze w swojej opiece.
	B_LogEntry          (Liliput,"Po otrzymaniu wszystkich sk³adników Cronos odprawi³ magiczny rytua³. Dziêki niemu Stuart powinien wróciæ do normalnego rozmiaru. Zobaczymy czy naprawdê siê uda³o.");
	AI_StopProcessInfos	(self);
...
FUNC VOID DIA_Cronos_Richard_Pomoc_Info()
{
    ...
    AI_Output (self, other ,"DIA_Cronos_Richard_Pomoc_03_02"); //Mam o wiele wiêcej spraw na g³owie ni¿ móg³byœ sobie wyobraziæ. Nie mam czasu na bzdury.
	AI_Output (other, self ,"DIA_Cronos_Richard_Pomoc_15_03"); //Ludzkie ¿ycie to chyba nie bzdura...
    AI_Output (self, other ,"DIA_Cronos_Richard_Pomoc_03_04"); //O co chodzi? Narazi³eœ siê Szkodnikom i chc¹ siê zabiæ? Nie mieszam siê w takie brudne sprawki...
	AI_Output (other, self ,"DIA_Cronos_Richard_Pomoc_15_05"); //Nie chodzi o mnie. Pewien cz³owiek otru³ siê toksycznym grzybem i potrzebuje lekarstwa.
    AI_Output (self, other ,"DIA_Cronos_Richard_Pomoc_03_06"); //Za g³upotê siê p³aci... aczkolwiek czemu by nie daæ komuœ drugiej szansy.
	AI_Output (self, other ,"DIA_Cronos_Richard_Pomoc_03_07"); //Mag Riordian zna siê na alchemii jak nikt. Jeœli tamten nieszczêœnik ma cieñ szansy to jest ni¹ w³aœnie on. 
    AI_Output (other, self ,"DIA_Cronos_Richard_Pomoc_15_08"); //Musze z nim pomówiæ.
	AI_Output (self, other ,"DIA_Cronos_Richard_Pomoc_03_09"); //Nie tak prêdko, on ma wyj¹tkowo du¿o pracy. Riordian nie przyjmuje dodatkowych zleceñ ale dla MNIE zrobi³by wyj¹tek...
	B_LogEntry               (DziwnaPrzypadlosc,"Cronos mo¿e mi pomóc w sprawie choroby Richarda. Poinformuje o tym problemie Riordiana a ten powinien sporz¹dziæ antidotum. Tyle, ¿e najpierw muszê udaæ siê na bagna do Nowicjusza Virana po roœliny, które chce Cronos.");
...
INSTANCE DIA_Cronos_Richard_Rio (C_INFO)
{
   ...
   permanent	= FALSE;
   description	= "Móg³byœ go poprosiæ o pomoc?";
};
...
{
    AI_Output (other, self ,"DIA_Cronos_Richard_Rio_15_01"); //Móg³byœ go poprosiæ o pomoc?
    AI_Output (self, other ,"DIA_Cronos_Richard_Rio_03_02"); //Nie za nic. Najpierw coœ dla mnie zrobisz.
	AI_Output (other, self ,"DIA_Cronos_Richard_Rio_15_03"); //Niby co?
    AI_Output (self, other ,"DIA_Cronos_Richard_Rio_03_04"); //Zamówi³em u Nowicjusza Virana z Sekty pewne specjalne bagienne roœliny.
	AI_Output (self, other ,"DIA_Cronos_Richard_Rio_03_05"); //Musisz je dla mnie odebraæ. Wtedy wrócimy do sprawy z Riordianem.
...
{
    AI_Output (other, self ,"DIA_Cronos_Richard_Rosliny_15_01"); //Mam twoje roœliny.
    AI_Output (self, other ,"DIA_Cronos_Richard_Rosliny_03_02"); //Zatem chce je zobaczyæ!
