...
FUNC VOID DIA_Baloro_Ziggy_Info()
{
    ...
    AI_Output (self, other ,"DIA_Baloro_Ziggy_03_02"); //Obozowego przy³upa. Dobraliœcie siê nieŸle. Barany...
    AI_Output (other, self ,"DIA_Baloro_Ziggy_15_03"); //A chcesz w pysk m¹dralo?
   AI_DrawWeapon (other);
    AI_Output (self, other ,"DIA_Baloro_Ziggy_03_04"); //Nie zaslugujesz nawet by skrzy¿owaæ z tob¹ orê¿, ofermo!
    AI_Output (other, self ,"DIA_Baloro_Ziggy_15_05"); //Jesteœ zbyt pewny siebie, mo¿e to pora by ciê trochê skróciæ.
   AI_StopProcessInfos	(self);
    Npc_SetTarget (self, other);
    AI_StartState (self, ZS_ATTACK, 1, "");
