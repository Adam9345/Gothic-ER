...
instance  DIA_Ghorim_Posazek (C_INFO)
{
	npc			= Nov_1310_Ghorim;
	nr			= 1;
	condition	= DIA_Ghorim_Posazek_Condition;
	information	= DIA_Ghorim_Posazek_Info;
	permanent	= 0;
	description	= "Mam twój pos¹¿ek. Ukrad³ ci go Mosul a potem wpad³ w ³apy Brago.";
};                       

FUNC int  DIA_Ghorim_Posazek_Condition()
{
	    if (Npc_KnowsInfo(hero,DIA_BaalNamib_BRAGO))
...
FUNC VOID  DIA_Ghorim_Posazek_Info()
{
	AI_Output (other, self,"DIA_Ghorim_Posazek_15_00"); //Mam twój pos¹¿ek. Ukrad³ ci go Mosul a potem wpad³ w ³apy Brago.
	AI_Output (self, other,"DIA_Ghorim_Posazek_02_01"); //Dziêki. Uczciwy z ciebie cz³owiek, weŸ te 100 bry³ek rudy w nagrodê.	
	CreateInvItems (self, itminugget, 100);
	B_GiveInvItems (self,other, itminugget, 100);
    B_GiveInvItems (other,self, ItMi_Stuff_Idol_Mosul, 1);
    B_GiveXP (50);
	//ShratHaveWork = TRUE;
};
