...
INSTANCE DIA_Mud_LSZ_Info (C_INFO)
{
   ...
   permanent	= FALSE;
   description	= "Mam wiadomoœæ od twojego brata.";
};
...
{
    AI_Output (other, self ,"DIA_Mud_LSZ_Info_15_01"); //Mam wiadomoœæ od twojego brata.
    AI_Output (self, other ,"DIA_Mud_LSZ_Info_03_02"); //O! Co u niego s³ychaæ?
    AI_Output (other, self ,"DIA_Mud_LSZ_Info_15_03"); //Có¿, bywa³o lepiej. Ale jakoœ ¿yje.
    AI_Output (self, other ,"DIA_Mud_LSZ_Info_03_04"); //Aaa rozumiem, kolego.
    AI_Output (other, self ,"DIA_Mud_LSZ_Info_15_05"); //Oto ta wiadomoœæ.
	B_GiveInvItems (other,self, ItWr_LSZ_ZiggyToMud, 1);
    B_UseFakeScroll ();
    AI_Output (self, other ,"DIA_Mud_LSZ_Info_03_06"); //Mój brat chcê mnie odwiedziæ! O bogowie, co teraz?
    AI_Output (self, other ,"DIA_Mud_LSZ_Info_03_07"); //Co on sobie o mnie pomyœli? W koñcu jest samym zarz¹dc¹ Wolnej Kopalni...
    AI_Output (other, self ,"DIA_Mud_LSZ_Info_15_08"); //Co?! Banda wariatów...
    AI_Output (self, other ,"DIA_Mud_LSZ_Info_03_09"); //Powiedz Ziggy’emu, ¿e mam nadmiar obowi¹zków jako Magnat. Bo... muszê liczyæ rudê Gomeza. Ot tak! Hah
    AI_Output (other, self ,"DIA_Mud_LSZ_Info_15_10"); //Nie bêdê tego komentowa³...
	B_LogEntry               (LatwySzmal,"Wrzód ok³ama³ swojego brata, ¿e jest Magnatem na dodatek Ziggy odwdziêczy³ mu siê tym samym twierdz¹c, ¿e jest szefem Wolnej Kopalni. Ci dwaj debile to na pewno rodzeni bracia. W ka¿dym razie Wrzód poprosi³ mnie bym powiedzia³ jego bratu, ¿e ma nadmiar obowi¹zków I nie mo¿e go przyj¹æ. Teraz pytanie co mu powiem, prawdê czy k³amstwo.");
    AI_StopProcessInfos	(self);
};
...
INSTANCE DIA_Mud_WhatDoYouAsking (C_INFO)
{
   ...
   permanent	= FALSE;
   description	= "Za co ciê tu wrzucono?";
};
...
{
    AI_Output (other, self ,"DIA_Mud_WhatDoYouAsking_15_01"); //Za co ciê tu wrzucono?
    AI_Output (self, other ,"DIA_Mud_WhatDoYouAsking_03_02"); //Za jakieœ g³upstwa no!
    AI_Output (self, other ,"DIA_Mud_WhatDoYouAsking_03_03"); //Nie zrobi³em nic z³ego. Pewnie moja inteligencja i wrodzony spryt byly dla kogoœ groŸne!
    ...
    AI_Output (self, other ,"DIA_Mud_WhatDoYouAsking_03_07"); //W³aœnie opracowywuje plan jak zaw³adn¹æ nad Starym Obozem. Wkrótce przejmuje ca³y ten bajzel!
    AI_Output (other, self ,"DIA_Mud_WhatDoYouAsking_15_08"); //Masz jak¹œ rodzinê lub krewnych?
    AI_Output (self, other ,"DIA_Mud_WhatDoYouAsking_03_09"); //Ju¿ nie...Znaczy mia³em kiedyœ brata. Nawet by³ wa¿n¹ osob¹ w Nowym Obozie....
    AI_Output (self, other ,"DIA_Mud_WhatDoYouAsking_03_10"); //Ale od dawna nie mam od niego ¿adnej wiadomoœci. Chyba nie ¿yje....
    AI_Output (self, other ,"DIA_Mud_WhatDoYouAsking_03_11"); //Tak mi mówi moja niezawodna intuicja. Ona siê nigdy nie myli.
    AI_Output (other, self ,"DIA_Mud_WhatDoYouAsking_15_12"); //Chyba pora bym szed³ dalej.
    AI_Output (self, other ,"DIA_Mud_WhatDoYouAsking_03_13"); // Zapewne te¿ myœlisz o tym co dalej ze sob¹ zrobiæ. Wzoruj siê na mnie a daleko zajdziesz!
    AI_Output (other, self ,"DIA_Mud_WhatDoYouAsking_15_14"); //Na razie chcê iœæ jak najdalej st¹d...
	 AI_StopProcessInfos	(self);
};
