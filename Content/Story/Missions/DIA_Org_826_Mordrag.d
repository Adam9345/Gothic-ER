...
INSTANCE DIA_Mordrag_Mine (C_INFO)
{
   npc          = Org_826_Mordrag;
   nr           = 1;
   condition    = DIA_Mordrag_Mine_Condition;
   information  = DIA_Mordrag_Mine_Info;
   permanent	= FALSE;
   description	= "Przysy³a mnie Lares...";
};

FUNC INT DIA_Mordrag_Mine_Condition()
{
    if (Npc_KnowsInfo (hero, DIA_Lares_Mine))
    {
    return TRUE;
    };
};
...
FUNC VOID DIA_Mordrag_Mine_Info()
{
    AI_Output (other, self ,"DIA_Mordrag_Mine_15_01"); //Przysy³a mnie Lares. Masz ujawniæ to¿samoœæ informatora w Starym Obozie, którego mia³eœ pozyskaæ.
    AI_Output (self, other ,"DIA_Mordrag_Mine_03_02"); //Ten informator to Kopacz imieniem Uscan. A czego chcesz siê od niego dowiedzieæ?
    AI_Output (other, self ,"DIA_Mordrag_Mine_15_03"); //Chodzi o wyruszenie pewnego konwoju ze Starego Obozu. Maj¹ eskortowaæ cz³owieka, który w naszym interesie powinien zgin¹æ.
    AI_Output (self, other ,"DIA_Mordrag_Mine_03_04"); //Skoro Lares chce jego œmierci to sprawa jest powa¿na. Nasz informator powinien o tym wiedzieæ.
    AI_Output (other, self ,"DIA_Mordrag_Mine_15_05"); //Idê do niego. Do zobaczenia.
    AI_Output (self, other ,"DIA_Mordrag_Mine_03_06"); //A by³bym zapomnia³! Za¿¹da on has³a. A brzmi ono ,,Œmieræ Magnatom”

    B_LogEntry                     (Zawirowania,"Mordrag twierdzi, ¿e naszym informatorem jest Kopacz o imieniu Uscan. Has³o, które mam mu powiedzieæ celem uwierzytelnienia brzmi : Œmieræ Magnatom.");
