...
FUNC VOID DIA_Drax_AboutRatford_Info()
{
    ...
    AI_Output (self, other ,"DIA_Drax_AboutRatford_03_02"); //Daj spokój. Denerwuje mnie ostatnio, jak ma³o kto.
...
FUNC VOID DIA_Drax_BANDYCI_STOSUNKI_Info()
{
    ...
    AI_Output (self, other ,"DIA_Drax_BANDYCI_STOSUNKI_03_05");	//Nie maj¹ jednak pojêcia, gdzie siê ukrywamy.
...
FUNC VOID DIA_Drax_JustGetGuild_Info()
{
	...
	{
	 AI_Output (self, other ,"DIA_Drax_JustGetGuild_03_04"); //Musisz jeszcze nad sob¹ popracowaæ, nim ciê przyjmiemy.
...
FUNC VOID DIA_Drax_EndPrzygotowan_Info()
{
    ...
    AI_Output (self, other ,"DIA_Drax_EndPrzygotowan_03_02"); //Zbada³em okolicê i rozrysowa³em wszystko na mapie. Najpierw zaatakujemy Stra¿ników, którzy za³o¿yli obóz na skarpie. 
	AI_Output (self, other ,"DIA_Drax_EndPrzygotowan_03_03"); //S¹ najbli¿ej nas i pewnie sporo widzieli. Na pewno prowadz¹ te¿ jakieœ zwiady.
    AI_Output (self, other ,"DIA_Drax_EndPrzygotowan_03_04"); //Gdy ju¿ siê z nimi rozprawimy przejdziemy przez most. Wzd³u¿ rzeki jest kolejny obóz. Trzeba tam uwa¿aæ, poniewa¿ jest to bardzo blisko bramy. 
    AI_Output (self, other ,"DIA_Drax_EndPrzygotowan_03_05"); //Nastêpna grupa znajduje siê przy lesie i w starej chacie przy drugiej bramie. Obejdziemy Stary Obóz z lewej strony. 
    AI_Output (other, self ,"DIA_Drax_EndPrzygotowan_15_06"); //To ca³y plan?
    AI_Output (self, other ,"DIA_Drax_EndPrzygotowan_03_07"); //Tak, to chyba wszystko. Teraz mam dla ciebie szczególe zadanie. Bêdziesz pilnowa³ szeregów Bandytów.
    AI_Output (self, other ,"DIA_Drax_EndPrzygotowan_03_08"); //Dbaj, ¿eby siê nie rozleŸli i nie rozpoczêli za wczeœnie ataków. 
    AI_Output (self, other ,"DIA_Drax_EndPrzygotowan_03_09"); //Nie róbcie du¿o ha³asu, po prostu idŸcie za mn¹.
    AI_Output (self, other ,"DIA_Drax_EndPrzygotowan_03_10"); //WeŸ tê mapê, z³ap oddech przed walk¹ i powiedz, gdy bêdziesz gotów. Zaraz wyruszamy. 
...
{
    if (Npc_GetDistToWP (self, "WP_ZZSG_DRAX") < 3000)
...
INSTANCE DIA_Drax_RyanDeath (C_INFO)
{
   npc          = BAN_1614_Drax;
   nr           = 1;
   condition    = DIA_Drax_RyanDeath_Condition;
   information  = DIA_Drax_RyanDeath_Info;
   permanent	= FALSE;
   description	= "Czy w dniu œmierci Rayana tobie i Ratfordowi ktoœ towarzyszy³?";
};

FUNC INT DIA_Drax_RyanDeath_Condition()
{
...
FUNC VOID DIA_Drax_RyanDeath_Info()
{
    AI_Output (other, self ,"DIA_Drax_RyanDeath_15_01"); //Czy w dniu œmierci Rayana tobie i Ratfordowi ktoœ towarzyszy³?
    AI_Output (self, other ,"DIA_Drax_RyanDeath_03_02"); //Wydaje mi siê, ¿e nie. Do czasu tamtego zgonu to by³ spokojny dzieñ. Nie wart zapamiêtania.
    AI_Output (other, self ,"DIA_Drax_RyanDeath_15_03"); //Rozumiem.
};
