...
INSTANCE DIA_Morok_HELLO1233 (C_INFO)
{
   npc          = GRD_7894_Morok;
   nr           = 1;
   condition    = DIA_Morok_HELLO1233_Condition;
   information  = DIA_Morok_HELLO1233_Info;
   permanent	= FALSE;
   important = TRUE;//description	= "Doœæ ju¿ waszych napadów i grabie¿y.";
};

FUNC INT DIA_Morok_HELLO1233_Condition()
{
...
FUNC VOID DIA_Morok_HELLO1233_Info()
{

    AI_Output (self, other ,"DIA_Morok_HELLO1233_03_00");   //Staæ marne gnidy!
    AI_Output (other, self ,"DIA_Morok_HELLO1233_15_01");   //Doœæ ju¿ waszych napadów i grabie¿y.
    AI_Output (self, other ,"DIA_Morok_HELLO1233_03_02");   //Tacy jesteœcie tego pewni wy marne wymoczki z Nowego Obozu?!
    AI_Output (other, self ,"DIA_Morok_HELLO1233_15_03");   //Nie zgrywaj siê! Bo wbije ci miecz w brzuch!
    AI_Output (other, self ,"DIA_Morok_HELLO1233_03_04");   //Gdzie s¹ ukradzione rzeczy waszych ofiar?!
	AI_Output (self, other ,"DIA_Morok_HELLO1233_03_05");   //Nigdy ci tego nie powiem œmieciu!
	AI_Output (self, other ,"DIA_Morok_HELLO1233_03_06");   //Prêdzej umrê ale ty gnoju niczego siê ode mnie nie dowiesz!
	AI_Output (other, self ,"DIA_Morok_HELLO1233_03_07");   //To siê jeszcze oka¿e!
	AI_Output (self, other ,"DIA_Morok_HELLO1233_03_08");   //Spróbuj gnido!
	GRD_7894_Morok.guild   = GIL_GOBBO;
	GRD_7896_Gardist.guild = GIL_GOBBO;
	GRD_7897_Gardist.guild = GIL_GOBBO;
	GRD_7898_Gardist.guild = GIL_GOBBO;
	GRD_7895_Patter.guild   = GIL_MEATBUG;
	
	B_ChangeGuild	(GRD_7897_Gardist, GIL_GOBBO);
	B_ChangeGuild	(GRD_7896_Gardist, GIL_GOBBO);
	B_ChangeGuild	(GRD_7898_Gardist, GIL_GOBBO);
	B_Story_MorokCamp_CH5_ATT();
	AI_StopProcessInfos	(self);
