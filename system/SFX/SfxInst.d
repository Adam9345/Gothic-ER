...
/* TestAMB   */	
				INSTANCE Test1		    				(C_SFX_DEF) {file= "wind_heavy01.wav";				vol = 127;			};
...
/* Special	 */
			...
			//	INSTANCE Revest            	(C_SFX_DEF) {file= "DIA_Connor_ENEMY_15_01.wav";					vol = 80;		};
...
/* Paper */	
				INSTANCE Map_Unfold						(C_SFX_DEF) {file= "BACKPACK_APPLY.wav";			vol = 60;			};
				INSTANCE Scroll_Unfold					(C_SFX_DEF) {file= "BACKPACK_APPLY.wav";				vol = 60;			};
...
/* Wind */	
				INSTANCE OW_WindHurricane				(C_SFX_DEF) {file= "wind_hurricane.wav";			vol = 90;        	};
				INSTANCE OW_WindHeavy1					(C_SFX_DEF) {file= "wind_heavy01.wav";				vol = 90;        	};
				INSTANCE OW_WindHeavy2					(C_SFX_DEF) {file= "wind_heavy02.wav";				vol = 90;        	};
				INSTANCE OW_WindHigh1					(C_SFX_DEF) {file= "wind_high.wav";					vol = 90;        	};
				INSTANCE OW_WindHigh2					(C_SFX_DEF) {file= "wind_high.wav";					vol = 90;        	};
				INSTANCE OW_WindMedium					(C_SFX_DEF) {file= "wind_medium.wav";				vol = 90;        	};
				INSTANCE OW_WindLight					(C_SFX_DEF) {file= "wind_light.wav";				vol = 90;        	};
				INSTANCE OW_WindLand 					(C_SFX_DEF) {file= "wind_light.wav";				vol = 90;        	};
				INSTANCE OW_WindCave					(C_SFX_DEF) {file= "wind_cave.wav";					vol = 90;        	};
				INSTANCE OW_WindCave2					(C_SFX_DEF) {file= "wind_cave2.wav";				vol = 90;        	};
				INSTANCE OW_WindCave3					(C_SFX_DEF) {file= "wind_gentle_cave.wav";			vol = 90;        	};
/* Water */	
...
/* Bear */	                                                                                                      		
				...
				INSTANCE bear_ambient_a2					(C_SFX_DEF) {file= "nosound.wav";			vol = 50;			};
				INSTANCE bear_ambient_a3					(C_SFX_DEF) {file= "nosound.wav";			vol = 50;			};
				
				INSTANCE BEAR_ROAR				    (C_SFX_DEF) {file= "BEAR_ROAR01.wav";	         	vol = 50;			};
				INSTANCE BEAR_ROAR_a1			    (C_SFX_DEF) {file= "BEAR_ROAR02.wav";	        	vol = 50;			};
				...
				INSTANCE bear_hurt_a3 					(C_SFX_DEF) {file= "BEAR_HURT04.wav";				vol = 60;			};		
				INSTANCE BEAR_SNOREIN					(C_SFX_DEF) {file= "BEAR_WHINE01.wav";		     	vol = 60;			};		
				INSTANCE BEAR_SNOREIN_a1					(C_SFX_DEF) {file= "BEAR_WHINE02.wav";		       	vol = 60;			};		
				INSTANCE BEAR_WARN_01 					(C_SFX_DEF) {file= "BEAR_WARN01.wav";				vol = 127;			};		
				INSTANCE BEAR_WARN_02 					(C_SFX_DEF) {file= "BEAR_WARN02.wav";				vol = 127;			};		
...
//	BERZERK
               ...
               INSTANCE SVM_15_SC_HEYTURNAROUND					(C_SFX_DEF) {file= "SVM_15_SC_HEYTURNAROUND.wav";				vol = 110;			};	
