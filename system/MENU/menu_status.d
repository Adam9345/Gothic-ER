...
/*
INSTANCE MENU_ITEM_TALENTS_MINING(C_MENU_ITEM_DEF)
{
	text[0]	= "Umiejêtnoœæ wydobycia";
	posx	= STAT_B_X1; posy = STAT_TAL_Y + STAT_DY*16;
	fontName	=	STAT_FONT_TITLE;
	flags		=	flags & ~IT_SELECTABLE;
};
*/
...
INSTANCE MENU_ITEM_TALENT_14_TITLE(C_MENU_ITEM_DEF)  { posx = STAT_B_X1;posy = STAT_TAL_Y + 19*STAT_DY;	fontName = STAT_FONT_DEFAULT;flags=flags & ~IT_SELECTABLE; };
instance MENU_ITEM_TALENT_14_SKILL(C_MENU_ITEM_DEF)  { posx = STAT_B_X2;posy = STAT_TAL_Y + 19*STAT_DY;	fontName = STAT_FONT_DEFAULT;flags=flags & ~IT_SELECTABLE; };
INSTANCE MENU_ITEM_TALENT_14(C_MENU_ITEM_DEF)        { posx = STAT_B_X3;posy = STAT_TAL_Y + 19*STAT_DY;	fontName = STAT_FONT_DEFAULT;flags=flags & ~IT_SELECTABLE; };
...
INSTANCE MENU_ITEM_TALENT_15(C_MENU_ITEM_DEF)        { posx = STAT_B_X3;posy = STAT_TAL_Y + 16*STAT_DY;	fontName = STAT_FONT_DEFAULT;flags=flags & ~IT_SELECTABLE; };

INSTANCE MENU_ITEM_TALENT_16_TITLE(C_MENU_ITEM_DEF)  { posx = STAT_B_X1;posy = STAT_TAL_Y + 16*STAT_DY;	fontName = STAT_FONT_DEFAULT;flags=flags & ~IT_SELECTABLE; };
instance MENU_ITEM_TALENT_16_SKILL(C_MENU_ITEM_DEF)  { posx = STAT_B_X2;posy = STAT_TAL_Y + 16*STAT_DY;	fontName = STAT_FONT_DEFAULT;flags=flags & ~IT_SELECTABLE; };
INSTANCE MENU_ITEM_TALENT_16(C_MENU_ITEM_DEF)        { posx = STAT_B_X3;posy = STAT_TAL_Y + 16*STAT_DY;	fontName = STAT_FONT_DEFAULT;flags=flags & ~IT_SELECTABLE; };